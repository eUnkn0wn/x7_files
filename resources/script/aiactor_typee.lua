...
function TypeE_CostumeSetting()
  AIActor:SetCostume(1000002, 3)
  AIActor:SetCostume(1010001, 0)
  AIActor:SetCostume(1020006, 1)
  AIActor:SetCostume(1030006, 1)
  AIActor:SetCostume(1040004, 1)
  AIActor:SetCostume(1050007, 0)
  AIActor:SetCostume(1060000, 0)
end
function TypeE_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeE_AIActorSetting()
...
function TypeE_AddNormalAIActorState()
...
function TypeE_AddRunAIActorState()
...
function TypeE_AddDamageAIActorState()
...
function TypeE_AddAttackAIActorState()
...
function TypeE_AddAttackNormalLowerState(state)
...
function TypeE_AddAttackRunLowerState(state)
...
function TypeE_AddDeathAIActorState()
