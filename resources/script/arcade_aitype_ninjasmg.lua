...
function Update()
  ...
  elseif TargetActor ~= nil and 0 < Util:GetDist(AIActor, TargetActor) and 100 > Util:GetDistByAttackArea(AIActor) and Util:IsVisible(AIActor, TargetActor) == true and 1 <= gAttackCount then
