...
function Tutorial_Loop()
  ...
  step_c = step_c + 1
  if step == step_c and TutorialSystem2:IsActorLocated(ACTOR.ME, POS.TARGET._02_1[1], POS.TARGET._02_1[2], POS.TARGET._02_1[3], 300) == true then
    TutorialSystem2:LockGamePlayInput(true)
    TutorialSystem2:PushActorCommandState(ACTOR.ME, STATE_NORMAL, 0)
    TutorialSystem2:RemoveGenEffectAll()
    TutorialSystem2:UnRegistAllArrowNodes()
  ...
  step_c = step_c + 1
  if step == step_c and TutorialSystem2:IsActorLocated(ACTOR.ME, POS.TARGET._03[1], POS.TARGET._03[2], POS.TARGET._03[3], 300) == true then
    TutorialSystem2:PushActorCommandState(ACTOR.ME, STATE_NORMAL, 0)
    TutorialSystem2:UnRegistAllArrowNodes()
    TutorialSystem2:LockGamePlayInput(true)
    TutorialSystem2:SetShowControlGuide(false, 0, 0)
