...
function Tutorial_Loop()
  ...
  step_c = step_c + 1
  if step == step_c then
    if TutorialSystem2:IsActorLocated(ACTOR.ENEMY_1, POS.ENEMY_SPAWN._01[1], POS.ENEMY_SPAWN._01[2], POS.ENEMY_SPAWN._01[3], 300) == true and TutorialSystem2:GetData(0, 0) then
      TutorialSystem2:ClearAllActorCommands(ACTOR.ENEMY_1)
      TutorialSystem2:PushActorCommandMoveToTarget(POS.ENEMY_SPAWN._02[1], POS.ENEMY_SPAWN._02[2], POS.ENEMY_SPAWN._02[3], -1, ACTOR.ENEMY_1)
      TutorialSystem2:SetData(0, 1)
    end
    if TutorialSystem2:IsActorLocated(ACTOR.ENEMY_1, POS.ENEMY_SPAWN._02[1], POS.ENEMY_SPAWN._02[2], POS.ENEMY_SPAWN._02[3], 300) == true and TutorialSystem2:GetData(0, 1) then
      TutorialSystem2:ClearAllActorCommands(ACTOR.ENEMY_1)
      TutorialSystem2:PushActorCommandMoveToTarget(POS.ENEMY_SPAWN._02[1], POS.ENEMY_SPAWN._01[2], POS.ENEMY_SPAWN._01[3], -1, ACTOR.ENEMY_1)
      TutorialSystem2:SetData(0, 0)
    end
    if 1 <= TutorialSystem2:GetBindCount() then
