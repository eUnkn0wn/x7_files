...
function TypeTeajo_CostumeSetting()
...
function TypeTeajo_WeaponSetting()
  AIActor:SetWeapon(2000002, 2)
end
function TypeTeajo_AIActorSetting()
  ...
  TypeTeajo_AddDeathAIActorState()
  TypeTeajo_AddNormalAIActorState()
  TypeTeajo_AddRunAIActorState()
  TypeTeajo_AddDamageAIActorState()
  TypeTeajo_AddAttack1AIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeTeajo_AddNormalAIActorState()
...
function TypeTeajo_AddRunAIActorState()
...
function TypeTeajo_AddDamageAIActorState()
...
function TypeTeajo_AddAttack1AIActorState()
  ...
  state:RegisterSound("Resources/Sound/voice_man_attack_3.ogg", "Bip01", 0, 2500)
  ...
  StateFactory:AddCounterSwordCounterAttacks(state, 15, 400)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
...
function TypeTeajo_AddDeathAIActorState()
