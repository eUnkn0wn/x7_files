...
function TypeD_CostumeSetting()
  AIActor:SetCostume(1001039, 0)
  AIActor:SetCostume(1010001, 0)
  AIActor:SetCostume(1021039, 0)
  AIActor:SetCostume(1031039, 0)
  AIActor:SetCostume(1041039, 0)
  AIActor:SetCostume(1051039, 0)
end
function TypeD_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeD_AIActorSetting()
  ...
  TypeA_AddDeathAIActorState()
  TypeA_AddNormalAIActorState()
  TypeA_AddRunAIActorState()
  TypeA_AddDamageAIActorState()
  TypeA_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeD_AddNormalAIActorState()
...
function TypeD_AddRunAIActorState()
...
function TypeD_AddDamageAIActorState()
...
function TypeD_AddAttackAIActorState()
  ...
  TypeA_AddAttackAILowerStates(state)
end
function TypeD_AddAttackAILowerStates(state)
  TypeA_AddAttackNormalLowerState(state)
  TypeA_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeD_AddAttackNormalLowerState(state)
...
function TypeD_AddAttackRunLowerState(state)
...
function TypeD_AddDeathAIActorState()
