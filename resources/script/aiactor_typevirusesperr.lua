...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeVirusEsperR_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
  AIActor:SetTeamByID(TEAM_BETA)
  AIActor:SetBaseMoveSpeedMax(900)
...
function TypeVirusEsperR_CostumeSetting()
...
function TypeVirusEsperR_WeaponSetting()
  AIActor:SetWeapon(2010002, 0)
end
function TypeVirusEsperR_AIActorSetting()
  ...
  TypeVirusEsperR_AddDeathAIActorState()
  TypeVirusEsperR_AddNormalAIActorState()
  TypeVirusEsperR_AddRunAIActorState()
  TypeVirusEsperR_AddDamageAIActorState()
  TypeVirusEsperR_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeVirusEsperR_AddNormalAIActorState()
...
function TypeVirusEsperR_AddRunAIActorState()
...
function TypeVirusEsperR_AddDamageAIActorState()
...
function TypeVirusEsperR_AddAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(800, 0, true, true, 0, false)
  StateFactory:AddRevolverNormalAttacks(state, 3, 0.04)
  local animBlender = state:GetAnimBlender()
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("Q0001", "Q0002", 0, 500, 0, false, 1, true)
  ...
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("Q0003", "Q0002", 0, 500, 0, false, 1, true)
  ...
  TypeVirusEsperR_AddAttackAILowerStates(state)
end
function TypeVirusEsperR_AddAttackAILowerStates(state)
  TypeVirusEsperR_AddAttackNormalLowerState(state)
  TypeVirusEsperR_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeVirusEsperR_AddAttackNormalLowerState(state)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("Q0002", 0, 500, 500, false, 1, true)
  lowerState:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeVirusEsperR_AddAttackRunLowerState(state)
