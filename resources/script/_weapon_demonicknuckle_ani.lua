...
function NormalState_DemonicKnuckle(state)
  ...
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("KN000", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
end
function RunState_DemonicKnuckle(state)
  ...
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_UPPER_FRONT):SetAnim("KN001", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_UPPER_LEFT_FRONT):SetAnim("KN002", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_UPPER_LEFT):SetAnim("KN003", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_UPPER_RIGHT_FRONT):SetAnim("KN004", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_UPPER_RIGHT):SetAnim("KN005", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_UPPER_BACK):SetAnim("KN006", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_UPPER_LEFT_BACK):SetAnim("KN007", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_UPPER_RIGHT_BACK):SetAnim("KN008", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_FRONT):SetAnim("KN001", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_LEFT_FRONT):SetAnim("KN002", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_LEFT):SetAnim("KN003", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_RIGHT_FRONT):SetAnim("KN004", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_RIGHT):SetAnim("KN005", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_BACK):SetAnim("KN006", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_LEFT_BACK):SetAnim("KN007", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LOWER_RIGHT_BACK):SetAnim("KN008", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
end
...
function ANI_LeftAttack_DemonicKnuckle(state)
  ...
  LEFT_HAND = 1
  RIGHT_HAND = 0
  state:GetAnimParam(RIGHT_HAND):SetAnim("KN012", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(LEFT_HAND):SetAnim("KN011", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  ...
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_FRONT):SetAnim("E0008", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_FRONT):SetAnim("E0009", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT):SetAnim("E0010", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT_FRONT):SetAnim("E0011", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT):SetAnim("E0012", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_BACK):SetAnim("E0013", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_BACK):SetAnim("E0014", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT_BACK):SetAnim("E0015", 800, 500, 500, LOOP_TRUE, 1, RESET_FALSE)
...
function ANI_LeftAttack2_DemonicKnuckle(state)
  ...
  state:GetAnimParam(ANIMPARAMLIST_NORMAL_FIRST):SetAnim("KN012", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  local lowerPartStateSet = state:GetLowerPartStateSet(0)
...
function ANI_LeftJump_DemonicKnuckle(state)
  ...
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_BEGIN):SetAnim("KN013", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("KN023", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
end
...
function ANI_RightAttack_DemonicKnuckle(state)
  ...
  local ANIMPARAMLIST_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("KN014", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("KN024", 800, 0, 1000, LOOP_FALSE, 1, RESET_TRUE)
end
