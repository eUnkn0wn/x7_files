...
function StandardBreakerJumpDash(  OneShotTime, Power, Accuracy, AdditionalPower )
	...
	Attack:InitAttack2( MAKEBOX( MAKEVECTOR3(0,0,-100), MAKEVECTOR3(0,0,-1), range*1.0, range*1.2, range*1.2 ), 1, 1, false  );   
...
function StandardBreakerAfterDash1(  OneShotTime, Power, Accuracy, AdditionalPower )
	...
	Attack1:InitAttack2( MAKEBOX( MAKEVECTOR3(0,200,0), MAKEVECTOR3(0,0,-1), range*1.5, range*0.7, range*1.0 ), 1, 1, false  );    --생성 기준점
...
function StandardBreakerAfterDash4(  OneShotTime, Power, Accuracy, AdditionalPower )
    ...
    Attack1 = CreateCAttack();
	Attack1:InitAttack1( WEAPONTYPE_BREAKER, ATTACKATTRIB_BREAKER_SWORD_ATTACK4, 600, Power+AdditionalPower, AdditionalPower ); --power 값 적용 안됨
    ...
    Attack2:InitAttack1( WEAPONTYPE_BREAKER, ATTACKATTRIB_BREAKER_SWORD_ATTACK4, 600, Power+AdditionalPower, AdditionalPower ); --power 값 적용 안됨
