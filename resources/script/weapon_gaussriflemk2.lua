...
function GaussRifleMK2_MultiShot(OneShotTime, Power, Accuracy, AdditionalPower)
  ...
  for index = 1, 7 do
    arDirs[index]:Normalize()
    Attack = CreateCAttack()
    Attack:InitAttack1(WEAPONTYPE_GAUSS_RIFLE_MK2, ATTACKATTRIB_GAUSS_RIFLE_MK2_RIGHT_ATTACK, AttackDelayTime + (index - 1) * OneShotTime, Power * 1.15 + AdditionalPower, AddtionalPower)
