...
function Tutorial_Step_First(step)
  if step == 0 then
    ...
    TutorialSystem2:SetWeaponSlot(ACTOR.ME, 0, WEAPON.CANO, 0)
    TutorialSystem2:SetWeaponSlot(ACTOR.ME, 1, WEAPON.KATA, 0)
    ...
    TutorialSystem2:ClearEnableInput()
    TutorialSystem2:SetTargetMaxPos(0.2)
...
function Tutorial_Step_Two(step)
  ...
  TutorialSystem2:SetItemControlUI(WEAPON.KATA)
  TutorialSystem2:SetPlayCount()
  TutorialSystem2:ChangeMessageWindow(MENT.CHARACTER1, 0)
  TutorialSystem2:SetStep(step + 1)
end
...
function Tutorial_Loop()
  ...
  if step == step_c then
    TutorialSystem2:SetItemControlUI(WEAPON.CANO)
    TutorialSystem2:SetStep(step + 1)
  end
  step_c = step_c + 1
  if step == step_c then
    ...
    TutorialSystem2:SetStep(step + 1)
    TutorialSystem2:SetChargeRateDamageCount(true)
  ...
  if step == step_c then
    ...
    if 2 <= TutorialSystem2:GetPlayerAttackCount(Weapon1State) and 2 <= TutorialSystem2:GetDamageCounter(ACTOR.ENEMY_1) then
      TutorialSystem2:LockGamePlayInput(true)
      TutorialSystem2:PushActorCommandState(ACTOR.ME, STATE_NORMAL, 0)
      TutorialSystem2:ChangeMessageWindow(MENT.CHARACTER1, 0)
      TutorialSystem2:SetStep(step + 1)
  ...
  if step == step_c then
    TutorialSystem2:LockGamePlayInput(true)
    TutorialSystem2:SetChargeRateDamageCount(false)
    TutorialSystem2:SetStep(step + 1)
  end
  step_c = step_c + 1
  if step == step_c then
  ...
  if step == step_c then
    ...
    if 2 <= TutorialSystem2:GetPlayerAttackCount(Weapon2State) and 2 <= TutorialSystem2:GetDamageCounter(ACTOR.ENEMY_1) then
      TutorialSystem2:LockGamePlayInput(true)
      TutorialSystem2:PushActorCommandState(ACTOR.ME, STATE_NORMAL, 0)
      TutorialSystem2:SetPlayCount()
  ...
  if step == step_c and TutorialSystem2:GetPlayCount() == 3 and TutorialSystem2:GetTimerState(1) == TIMER.END then
    TutorialSystem2:ChangeMessageWindow(MENT.CHARACTER1, 0)
    TutorialSystem2:PushActorCommandState(ACTOR.ME, STATE_NORMAL, 0)
    TutorialSystem2:SetStep(step + 1)
  end
