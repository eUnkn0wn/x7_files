...
function TypeA_CostumeSetting()
  AIActor:SetCostume(1000002, 3)
  AIActor:SetCostume(1010001, 0)
  AIActor:SetCostume(1021040, 0)
  AIActor:SetCostume(1031040, 0)
  AIActor:SetCostume(1041040, 0)
  AIActor:SetCostume(1051040, 0)
  AIActor:SetCostume(1061040, 0)
end
function TypeA_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeA_AIActorSetting()
...
function TypeA_AddNormalAIActorState()
...
function TypeA_AddRunAIActorState()
...
function TypeA_AddDamageAIActorState()
...
function TypeA_AddAttackAIActorState()
...
function TypeA_AddAttackRunLowerState(state)
...
function TypeA_AddDeathAIActorState()
