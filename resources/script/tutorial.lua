...
GUI_HP_GUAGE = 16384
index = 0
KEYBOARD_STATE_NONE = index
index = index + 1
KEYBOARD_STATE_GUIDE = index
index = index + 1
KEYBOARD_STATE_MOVE_W = index
index = index + 1
KEYBOARD_STATE_MOVE_A = index
index = index + 1
KEYBOARD_STATE_MOVE_S = index
index = index + 1
KEYBOARD_STATE_MOVE_D = index
index = index + 1
KEYBOARD_STATE_GUIDE_JUMP = index
index = index + 1
KEYBOARD_STATE_JUMP = index
index = index + 1
KEYBOARD_STATE_FRONT_JUMP = index
index = index + 1
KEYBOARD_STATE_AVOID_LEFT = index
index = index + 1
KEYBOARD_STATE_AVOID_RIGHT = index
index = index + 1
KEYBOARD_STATE_BLOCK_JUMP = index
index = index + 1
KEYBOARD_STATE_RUN = index
index = index + 1
MOUSE_GUIDE = index
index = index + 1
...
CURE_ALL = 2
index = 0
MESSION_STEP01_VIEW = index
index = index + 1
MESSION_STEP01_MOVE = index
index = index + 1
MESSION_STEP02_MOVE = index
index = index + 1
MESSION_STEP03_DESTROY_BLAST = index
index = index + 1
MESSION_STEP04_DESTROY_ENERMY01 = index
index = index + 1
MESSION_STEP04_DESTROY_ENERMY02 = index
index = index + 1
MESSION_STEP04_DODGE = index
index = index + 1
MESSION_STEP04_DESTROY_ENERMY03 = index
index = index + 1
MESSION_STEP04_MOVE = index
index = index + 1
MESSION_STEP05_CATCH_BALL = index
index = index + 1
MESSION_STEP05_MOVE = index
index = index + 1
MESSION_STEP06_MOVE = index
index = index + 1
function InitializeTutorialStage()
  TutorialSystem:SetTotalStage(1)
  InitEasyKeyControlStage()
end
function InitEasyKeyControlStage()
  ...
  GMImageController01 = TriggerPackage:GetGUIGMImageController(0, IMAGE_NONE, 0)
  EventAlram = TriggerPackage:GetEventAlram(0, START_EVENT, 3000, START_EVENT, false)
  KeyPressChecker00 = TriggerPackage:GetKeyPressChecker(0, KEYBOARD_STATE_NONE, 0, 0)
  GMImageController02 = TriggerPackage:GetGUIGMImageController(START_EVENT, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_EMOTION_IMAGE + GUI_SEABOM_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  ...
  GMImageController03 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM07, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 4)
  ...
  GMImageController04 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM11, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_EMOTION_IMAGE + GUI_SEABOM_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  SeabomGuideLabel04 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM11, STAND4_KEY_LABEL, EVENT_ALRAM12, 50)
  MoveKeyGuideViewer04 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE, EVENT_ALRAM11, true, 0, 0)
  ...
  GMImageController05 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM15, GUI_TEXT_VIEWER_BACK_2 + GUI_TEXT_VIEWER_2, 0)
  SeabomGuideLabel05 = TriggerPackage:GetMessage2TextWriter(EVENT_ALRAM15, STAND5_KEY_LABEL, 0)
  MoveKeyGuideViewer06 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_MOVE_W, EVENT_ALRAM15, true, 0, 0)
  ...
  MoveKeyGuideViewer07 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_MOVE_S, EVENT_ALRAM16, true, 0, 0)
  ...
  MoveKeyGuideViewer08 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_MOVE_A, EVENT_ALRAM17, true, 0, 0)
  ...
  MoveKeyGuideViewer09 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_MOVE_D, EVENT_ALRAM18, true, 0, 0)
  PressNextEnterChecker08 = TriggerPackage:GetKeyPressCheckerEx(EVENT_ALRAM18, EVENT_ALRAM19, IK_D, EVENT_ALRAM19)
  GMImageController06 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM19, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 4)
  SeabomGuideLabel09 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM19, STAND9_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer10 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE, EVENT_ALRAM19, true, 0, 0)
  ...
  GMImageController07 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM22, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  SeabomGuideLabel10 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM22, STAND10_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer11 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE_JUMP, EVENT_ALRAM22, true, 0, 0)
  ...
  GMImageController07_text = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM24, GUI_TEXT_VIEWER_BACK_2 + GUI_TEXT_VIEWER_2, 0)
  SeabomGuideLabel11 = TriggerPackage:GetMessage2TextWriter(EVENT_ALRAM24, STAND11_KEY_LABEL, 0)
  MoveKeyGuideViewer12 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_JUMP, EVENT_ALRAM24, true, 0, 0)
  PressNextEnterChecker11 = TriggerPackage:GetKeyPressCheckerEx(EVENT_ALRAM24, EVENT_ALRAM25, IK_SPACE, EVENT_ALRAM25)
  GMImageController08 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM25, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 4)
  SeabomGuideLabel12 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM25, STAND12_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer13 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE_JUMP, EVENT_ALRAM22, true, 0, 0)
  ...
  GMImageController09 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM27, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  SeabomGuideLabel13 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM27, STAND13_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer14_1 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE_JUMP, EVENT_ALRAM27, true, 0, 0)
  ...
  GMImageController09_text = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM29, GUI_TEXT_VIEWER_BACK_2 + GUI_TEXT_VIEWER_2, 0)
  MoveKeyGuideViewer14 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_FRONT_JUMP, EVENT_ALRAM29, true, 0, 0)
  SeabomGuideLabel13_1 = TriggerPackage:GetMessage2TextWriter(EVENT_ALRAM29, STAND14_KEY_LABEL, 0)
  KeyPressChecker01 = TriggerPackage:GetKeyPressChecker(EVENT_ALRAM29, KEYBOARD_STATE_FRONT_JUMP, EVENT_ALRAM30, EVENT_ALRAM30)
  GMImageController10 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM30, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 4)
  SeabomGuideLabel14 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM30, STAND15_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer15 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE_JUMP, EVENT_ALRAM30, true, 0, 0)
  ...
  GMImageController11 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM32, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  ...
  GMImageController11_text = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM36, GUI_TEXT_VIEWER_BACK_2 + GUI_TEXT_VIEWER_2 + GUI_SP_GUAGE + GUI_HP_GUAGE, 0)
  SeabomGuideLabel17 = TriggerPackage:GetMessage2TextWriter(EVENT_ALRAM36, STAND18_KEY_LABEL, 0)
  MoveKeyGuideViewer19 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_AVOID_LEFT, EVENT_ALRAM36, true, 0, 0)
  KeyPressChecker02 = TriggerPackage:GetKeyPressChecker(EVENT_ALRAM36, KEYBOARD_STATE_AVOID_LEFT, EVENT_ALRAM37, EVENT_ALRAM37)
  SeabomGuideLabel18 = TriggerPackage:GetMessage2TextWriter(EVENT_ALRAM37, STAND19_KEY_LABEL, 0)
  MoveKeyGuideViewer20 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_AVOID_RIGHT, EVENT_ALRAM37, true, 0, 0)
  KeyPressChecker03 = TriggerPackage:GetKeyPressChecker(EVENT_ALRAM37, KEYBOARD_STATE_AVOID_RIGHT, EVENT_ALRAM38, EVENT_ALRAM38)
  GMImageController13 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM38, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 4)
  SeabomGuideLabel19 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM38, STAND20_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer21 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE_JUMP, EVENT_ALRAM38, true, 0, 0)
  ...
  GMImageController14 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM40, GUI_TEXT_VIEWER_BACK_2 + GUI_NEXT_BUTTON_2 + GUI_SP_ARROW + GUI_TEXT_VIEWER_2 + GUI_SP_GUAGE + GUI_HP_GUAGE, 0)
  ...
  GMImageController15 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM41, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  ...
  GMImageController15_text = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM43, GUI_TEXT_VIEWER_BACK_2 + GUI_TEXT_VIEWER_2 + GUI_SP_GUAGE + GUI_HP_GUAGE, 0)
  SeabomGuideLabel22 = TriggerPackage:GetMessage2TextWriter(EVENT_ALRAM43, STAND23_KEY_LABEL, 0)
  MoveKeyGuideViewer22 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_BLOCK_JUMP, EVENT_ALRAM43, true, 0, 0)
  KeyPressChecker04 = TriggerPackage:GetKeyPressChecker(EVENT_ALRAM43, KEYBOARD_STATE_BLOCK_JUMP, 0, EVENT_ALRAM44)
  ActorAttackCheck01 = TriggerPackage:GetActorAttackObserverEx(EVENT_ALRAM43, EVENT_ALRAM44, "BOUNDJUMP", EVENT_ALRAM44)
  GMImageController16 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM44, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 4)
  SeabomGuideLabel23 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM44, STAND24_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer23 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_GUIDE_JUMP, EVENT_ALRAM44, true, 0, 0)
  ...
  GMImageController17 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM46, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  SeabomGuideLabel24 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM46, STAND25_KEY_LABEL, 0, 50)
  ...
  SeabomGuideLabel24_skip = TriggerPackage:GetMessage1TextWriter(EVENT_ALRAM47, STAND25_KEY_LABEL, 0, 50)
  ...
  GMImageController17_text = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM48, GUI_TEXT_VIEWER_BACK_2 + GUI_TEXT_VIEWER_2 + GUI_SP_GUAGE + GUI_HP_GUAGE, 0)
  SeabomGuideLabel23_1 = TriggerPackage:GetMessage2TextWriter(EVENT_ALRAM48, STAND26_KEY_LABEL, 0)
  ...
  GMImageController18 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM49, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  ...
  GMImageController19 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM52, GUI_SEABOM_NAME_TEXT + GUI_SEABOM_IMAGE + GUI_SEABOM_EMOTION_IMAGE + GUI_TEXT_VIEWER_BACK_1 + GUI_NEXT_BUTTON_1 + GUI_TEXT_VIEWER_1, 8)
  SeabomGuideLabel26 = TriggerPackage:GetMessage1AniTextWriter(EVENT_ALRAM52, STAND28_KEY_LABEL, 0, 50)
  MoveKeyGuideViewer24 = TriggerPackage:GetGUIViewer(KEYBOARD_STATE_RUN, EVENT_ALRAM52, true, 0, 0)
  ...
  GMImageController20 = TriggerPackage:GetGUIGMImageController(EVENT_ALRAM54, GUI_TEXT_VIEWER_BACK_2 + GUI_TEXT_VIEWER_2 + GUI_SP_GUAGE + GUI_HP_GUAGE, 8)
  ...
  KeyPermiter01 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), 0, 0, false)
  KeyPermiter02 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM15, EVENT_ALRAM15, true)
  KeyPermiter03 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM20, EVENT_ALRAM20, false)
  KeyPermiter04 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM24, EVENT_ALRAM24, true)
  KeyPermiter05 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM26, EVENT_ALRAM26, false)
  KeyPermiter06 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM29, EVENT_ALRAM29, true)
  KeyPermiter07 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM30, EVENT_ALRAM30, false)
  KeyPermiter08 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM36, EVENT_ALRAM36, true)
  KeyPermiter09 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM38, EVENT_ALRAM38, false)
  KeyPermiter10 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM43, EVENT_ALRAM43, true)
  KeyPermiter11 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM44, EVENT_ALRAM44, false)
  KeyPermiter12 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM48, EVENT_ALRAM48, true)
  KeyPermiter13 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM49, 0, true)
  KeyPermiter14 = TriggerPackage:GetKeyPermiter(TutorialSystem:GetInputSystem(), EVENT_ALRAM54, EVENT_ALRAM53, true)
