...
WEAPON1STATE_ANIMTABLE.UseWeapon1State_SpyDagger_military = UseWeapon1State_SpyDagger_military
...
WEAPON2STATE_ANIMTABLE.UseWeapon2State_SpyDagger_military = UseWeapon2State_SpyDagger_military
...
WEAPON1WEAK_ANIMTABLE.SwordAtkAfterDash1State_CounterSword_retro = SwordAtkAfterDash1State_CounterSword_retro
...
WEAPON1STRONG_ANIMTABLE.SwordAtkAfterDash1State_DoubleSword = SwordAtkAfterDash1State_DoubleSword
...
WEAPON1STRONG_ANIMTABLE.SwordAtkCounterAttack_CounterSword_retro = SwordAtkCounterAttack_CounterSword_retro
...
WEAPON1JUMP_ANIMTABLE.SwordJumpAtkState_Breaker_heart = SwordJumpAtkState_Breaker_heart
...
WEAPON1JUMP_ANIMTABLE.SwordJumpAtkState_CounterSword_retro = SwordJumpAtkState_CounterSword_retro
...
WEAPON1ATTACK2_ANIMTABLE.SwordAtkAfterDash2State_CounterSword_retro = SwordAtkAfterDash2State_CounterSword_retro
...
WEAPON1ATTACK3_ANIMTABLE.SwordAtkAfterDash3State_CounterSword_retro = SwordAtkAfterDash3State_CounterSword_retro
...
WEAPON1ATTACK4_ANIMTABLE.SwordAtkAfterDash4State_CounterSword_retro = SwordAtkAfterDash4State_CounterSword_retro
...
WEAPON1COUNTERATTACK_ANIMTABLE.SwordAtkCounterAttack_CounterSword_retro = SwordAtkCounterAttack_CounterSword_retro
...
ESPERACTIONANIMTABLE[ANIM_ESPERACTION_ESPERCOAT] = EsperSkill_EsperCoat
ESPERACTIONANIMTABLE[ANIM_ESPERACTION_ESPERBOMB] = EsperSkill_EsperBomb
ESPERACTIONANIMTABLE[ANIM_ESPERACTION_KNEESLIDE] = EsperSkill_EsperKneeSlide
...
function ActorState_Sit(state)
  local index = 0
  local ANIMPARAMLIST_STANDBY = index
  index = index + 1
  local ANIMPARAMLIST_FRONT = index
  index = index + 1
  local ANIMPARAMLIST_LEFT_FRONT = index
  index = index + 1
  local ANIMPARAMLIST_LEFT = index
  index = index + 1
  local ANIMPARAMLIST_RIGHT_FRONT = index
  index = index + 1
  local ANIMPARAMLIST_RIGHT = index
  index = index + 1
  local ANIMPARAMLIST_BACK = index
  index = index + 1
  local ANIMPARAMLIST_LEFT_BACK = index
  index = index + 1
  local ANIMPARAMLIST_RIGHT_BACK = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_STANDBY):SetAnim("00065", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_FRONT):SetAnim("00057", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LEFT_FRONT):SetAnim("00058", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LEFT):SetAnim("00059", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_RIGHT_FRONT):SetAnim("00060", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_RIGHT):SetAnim("00061", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_BACK):SetAnim("00062", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_LEFT_BACK):SetAnim("00063", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
  state:GetAnimParam(ANIMPARAMLIST_RIGHT_BACK):SetAnim("00064", 0, 1000, 0, LOOP_TRUE, 1, RESET_FALSE)
end
function ActorState_Jump(state)
  local index = 0
  local ANIMPARAMLIST_DELAY_BEFORE_JUMP = index
  index = index + 1
  local ANIMPARAMLIST_JUMP_RISE = index
  index = index + 1
  local ANIMPARAMLIST_JUMP_MOVE_RISE = index
  index = index + 1
  local ANIMPARAMLIST_LANDING = index
  index = index + 1
  local ANIMPARAMLIST_LANDING_MOVE = index
  index = index + 1
  local ANIMPARAMLIST_FALL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_DELAY_BEFORE_JUMP):SetAnim("00000", 0, 500, 1000, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_JUMP_RISE):SetAnim("00001", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_JUMP_MOVE_RISE):SetAnim("00004", 600, 100, 300, LOOP_FALSE, 1, RESET_TRUE)
  ...
  state:GetAnimParam(ANIMPARAMLIST_FALL):SetAnim("00002", 0, 1000, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function ActorState_BoundJump(state)
  local index = 0
  local ANIMPARAMLIST_DELAY_BEFORE_JUMP = index
  index = index + 1
  local ANIMPARAMLIST_JUMP_RISE_A = index
  index = index + 1
  local ANIMPARAMLIST_JUMP_RISE_B = index
  index = index + 1
  local ANIMPARAMLIST_JUMP_FALL_A = index
  index = index + 1
  local ANIMPARAMLIST_JUMP_FALL_B = index
  index = index + 1
  local ANIMPARAMLIST_LANDING = index
  index = index + 1
  local ANIMPARAMLIST_FAIL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_DELAY_BEFORE_JUMP):SetAnim("00066", 500, 0, 500, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_JUMP_RISE_A):SetAnim("00067", 500, 100, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_JUMP_RISE_B):SetAnim("00067_2", 500, 200, 1000, LOOP_FALSE, 0.8, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_JUMP_FALL_A):SetAnim("00002", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_JUMP_FALL_B):SetAnim("00002", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_LANDING):SetAnim("00003", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_FAIL):SetAnim("00002", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function ActorState_Fall(state)
  local index = 0
  local ANIMPARAMLIST_FALLING = index
  index = index + 1
  local ANIMPARAMLIST_LANDING = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_FALLING):SetAnim("00002", 0, 1000, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_LANDING):SetAnim("00003", 380, 200, 300, LOOP_FALSE, 1, RESET_TRUE)
end
function ActorState_Dodge(state)
  local index = 0
  local ANIMPARAMLIST_DODGE_FRONT = index
  index = index + 1
  local ANIMPARAMLIST_DODGE_BACK = index
  index = index + 1
  local ANIMPARAMLIST_DODGE_LEFT = index
  index = index + 1
  local ANIMPARAMLIST_DODGE_RIGHT = index
  index = index + 1
  local ANIMPARAMLIST_DELAY_FRONT = index
  index = index + 1
  local ANIMPARAMLIST_DELAY_BACK = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_DODGE_FRONT):SetAnim("00038", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DODGE_BACK):SetAnim("00041", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DODGE_LEFT):SetAnim("00005", 0, 300, 700, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DODGE_RIGHT):SetAnim("00056", 0, 300, 700, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY_FRONT):SetAnim("00039", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY_BACK):SetAnim("00042", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function ActorState_Stun(state)
  ...
  local index = 0
  local ANIMPARAMLIST_PRECEDING = index
  index = index + 1
  local ANIMPARAMLIST_STUN = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_PRECEDING):SetAnim("00006", 0, 0, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_STUN):SetAnim("00007", 0, 1000, 0, LOOP_TRUE, 1, RESET_TRUE)
end
...
function ActorState_Down(state)
  ...
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("00021", 0, 1000, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function ActorState_Standup(state)
  ...
  local ANIMPARAMLIST_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("00035", 0, 0, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function ActorState_Blow(state)
  ...
  local index = 0
  local ANIMPARAMLIST_BEGIN_NORMAL = index
  index = index + 1
  local ANIMPARAMLIST_BEGIN_DEATH = index
  index = index + 1
  local ANIMPARAMLIST_MIDDLE_NORMAL = index
  index = index + 1
  local ANIMPARAMLIST_MIDDLE_DEATH = index
  index = index + 1
  local ANIMPARAMLIST_END_NORMAL = index
  index = index + 1
  local ANIMPARAMLIST_END_DEATH = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_BEGIN_NORMAL):SetAnim("00027", 0, 0, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_BEGIN_DEATH):SetAnim("00026", 0, 0, 0, LOOP_FALSE, 0.8, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_MIDDLE_NORMAL):SetAnim("00026", 0, 200, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_MIDDLE_DEATH):SetAnim("00026", 0, 200, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_END_NORMAL):SetAnim("00024", 0, 400, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_END_DEATH):SetAnim("00026", 0, 400, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function ActorState_BoundBlow(state)
  ...
  local ANIMPARAMLIST_END_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_BEGIN_NORMAL):SetAnim("00070", 0, 100, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_MIDDLE_NORMAL):SetAnim("00071", 0, 100, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_END_NORMAL):SetAnim("00072", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
end
...
function ActorState_DownDamage(state)
  state:AddSoundBySex("Resources/Sound/voice_man_damage_3.ogg", "Resources/Sound/voice_girl_damage_3.ogg", "Bip01", 0, 2500)
  local index = 0
  local ANIMPARAMLIST_UPSET_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_UPSET_NORMAL):SetAnim("00023", 0, 100, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function ActorState_Death(state)
  state:AddSequence(1, "Resources/Effects/dead_eff.seq", "", 1, 0)
  local index = 0
  local ANIMPARAMLIST_FALLDOWN_NORMAL_WEAK = index
  index = index + 1
  local ANIMPARAMLIST_FALLDOWN_NORMAL_STRONG = index
  index = index + 1
  local ANIMPARAMLIST_FALLDOWN_BLOW = index
  index = index + 1
  local ANIMPARAMLIST_FALLDOWN_BOUNDBLOW_NORMAL = index
  index = index + 1
  local ANIMPARAMLIST_LIEDOWN_BOUNDBLOW_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_FALLDOWN_NORMAL_WEAK):SetAnim("00030", 0, 0, 0, LOOP_FALSE, 1.3, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_FALLDOWN_NORMAL_STRONG):SetAnim("00069", 0, 0, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_FALLDOWN_BLOW):SetAnim("00024", 0, 500, 0, LOOP_FALSE, 1.5, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_FALLDOWN_BOUNDBLOW_NORMAL):SetAnim("00071", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_LIEDOWN_BOUNDBLOW_NORMAL):SetAnim("00072", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
end
...
function ActorState_UpperCut(state)
  ...
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("GR005", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_END):SetAnim("GR006", 0, 200, 1000, LOOP_FALSE, 1, RESET_TRUE)
end
...
function Skill_Fly(state)
  ...
  local ANIMPARAMLIST_STANDBY = index
  index = index + 1
  local ANIMPARAMLIST_RISE_BEGIN = index
  index = index + 1
  local ANIMPARAMLIST_RISE_LOOP = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_BEGIN):SetAnim("M0000", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_STANDBY):SetAnim("M0001", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_RISE_BEGIN):SetAnim("M0002", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_RISE_LOOP):SetAnim("M0001", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function Skill_Anchoring(state)
  local index = 0
  local ANIMPARAMLIST_AIMING = index
  index = index + 1
  local ANIMPARAMLIST_SHOT = index
  index = index + 1
  local ANIMPARAMLIST_WAITING = index
  index = index + 1
  local ANIMPARAMLIST_PULLING = index
  index = index + 1
  local ANIMPARAMLIST_DROP = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_AIMING):SetAnim("L0002", 0, 200, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_SHOT):SetAnim("L0000", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_WAITING):SetAnim("L0002", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_PULLING):SetAnim("L0001", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DROP):SetAnim("00065", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function ActorState_FastRun(state)
  ...
  state:SetAniPlaySpeed_IronBoots(0.5, 1)
  local index = 0
  local ANIMPARAMLIST_NORMAL = index
  index = index + 1
  local ANIMPARAMLIST_IRON_BOOTS_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("00068", 0, 200, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_IRON_BOOTS_NORMAL):SetAnim("IB068", 0, 200, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function Skill_Stealth(state)
  state:AddSequence(0, "Resources/Effects/skill_hacker_invisibility.seq", "", 0, 2500)
  local index = 0
  local ANIMPARAMLIST_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("J0000", 0, 1000, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function Skill_Shield(state)
  ...
  local ANIMPARAMLIST_END = index
  index = index + 1
  local ANIMPARAMLIST_IRON_BOOTS_BEGIN = index
  index = index + 1
  local ANIMPARAMLIST_IRON_BOOTS_END = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_BEGIN):SetAnim("I0003", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_END):SetAnim("I0004", 0, 1000, 0, LOOP_TRUE, 1, RESET_TRUE)
  ...
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_NORMAL):SetAnim("I0004", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_IRON_BOOTS_BEGIN):SetAnim("I0003", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_IRON_BOOTS_END):SetAnim("I0004", 0, 1000, 0, LOOP_TRUE, 1, RESET_TRUE)
  lowerPartStateSet = state:GetLowerPartStateSet(1)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_FRONT):SetAnim("IB008_1", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_FRONT):SetAnim("IB009_1", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT):SetAnim("IB010", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT_FRONT):SetAnim("IB011_1", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT):SetAnim("IB012", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_BACK):SetAnim("IB013", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_BACK):SetAnim("IB014", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT_BACK):SetAnim("IB015", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_NORMAL):SetAnim("IB000", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function Skill_WallCreation(state)
  local index = 0
  local ANIMPARAMLIST_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("I0000", 750, 500, 1000, LOOP_FALSE, 1, RESET_TRUE)
  lowerPartStateSet = state:GetLowerPartStateSet(0)
  ...
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_NORMAL):SetAnim("I0000", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function Skill_Bind(state)
  local index = 0
  local ANIMPARAMLIST_NORMAL = index
  index = index + 1
  local ANIMPARAMLIST_RECOVERY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("S0000", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_RECOVERY):SetAnim("S0001", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
  lowerPartStateSet = state:GetLowerPartStateSet(0)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_FRONT):SetAnim("DD005", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_FRONT):SetAnim("DD006", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT):SetAnim("DD007", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
...
function Skill_Metalic(state)
  ...
  local ANIMPARAMLIST_RECOVERY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("U0000", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_LOOP):SetAnim("U0001", 0, 300, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_RECOVERY):SetAnim("U0002", 0, 300, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function Skill_Berserk(state)
  ...
  local ANIMPARAMLIST_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("T0000", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
end
function Skill_Temp0(state)
  ...
  local ANIMPARAMLIST_NORMAL = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("DC008", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
  lowerPartStateSet = state:GetLowerPartStateSet(0)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_FRONT):SetAnim("H0004", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_FRONT):SetAnim("H0005", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT):SetAnim("H0006", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  ...
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_BACK):SetAnim("H0010", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT_BACK):SetAnim("H0011", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_NORMAL):SetAnim("S0000", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
end
...
function UseWeapon1_Weak(state)
  ...
  SwordAtkAfterDash1State_CounterSword_retro(state:GetStatePerWeapon(WEAPONTYPE_COUNTER_SWORD))
end
function UseWeapon1_Strong(state)
  ...
  SwordAtkCounterAttack_CounterSword_retro(state:GetStatePerWeapon(WEAPONTYPE_COUNTER_SWORD))
end
function UseWeapon1_Jump(state)
  ...
  SwordJumpAtkState_CounterSword_retro(state:GetStatePerWeapon(WEAPONTYPE_COUNTER_SWORD))
end
...
function UseWeapon1_Attack2(state)
  ...
  SwordAtkAfterDash2State_CounterSword_retro(state:GetStatePerWeapon(WEAPONTYPE_COUNTER_SWORD))
end
function UseWeapon1_Attack3(state)
  ...
  SwordAtkAfterDash3State_CounterSword_retro(state:GetStatePerWeapon(WEAPONTYPE_COUNTER_SWORD))
end
function UseWeapon1_Attack4(state)
  ...
  SwordAtkAfterDash4State_CounterSword_retro(state:GetStatePerWeapon(WEAPONTYPE_COUNTER_SWORD))
end
