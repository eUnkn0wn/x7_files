...
function SwordAtkStrongState_BatSword(state)
  ...
  local ANIMPARAMLIST_THIRD = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_FIRST):SetAnim("BB001", 900, 200, 500, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_SECOND):SetAnim("BB001", 900, 200, 500, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_THIRD):SetAnim("BB001", 900, 200, 500, LOOP_FALSE, 1, RESET_TRUE)
  local lowerPartStateSet = state:GetLowerPartStateSet(0)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_FRONT):SetAnim("E0008", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_FRONT):SetAnim("E0009", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT):SetAnim("E0010", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
...
function SwordJumpAtkState_BatSword(state)
  ...
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("A0016", 1000, 50, 500, LOOP_FALSE, 1, RESET_TRUE)
end
function SwordAtkStrong1State_BatSword(state)
  ...
  local ANIMPARAMLIST_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("BB001", 900, 200, 500, LOOP_FALSE, 1, RESET_TRUE)
...
function UseWeapon1Attack2State_BatSword(state)
  ...
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("BB002", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("BB003", 0, 0, 400, LOOP_FALSE, 1, RESET_TRUE)
end
...
function UseWeapon1Attack4State_BatSword(state)
  ...
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("BB002", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("BB003", 0, 0, 200, LOOP_FALSE, 1, RESET_TRUE)
end
...
function UseWeapon2State_BatSword(state)
  ...
  state:AddSequence(0, "", "Resources/Sound/bat_swing.ogg", 0, 5000)
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("BB002", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("BB004", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
end
