...
function TypeTRA_test_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
  AIActor:SetTeamByID(TEAM_BETA)
  AIActor:SetBaseMoveSpeedMax(800)
...
function TypeTRA_AddAttackAIActorState()
  ...
  StateFactory:AddTRA_Attacks(state, 800, 5, 500)
...
function TypeTRA_AddAttack2AIActorState()
  ...
  StateFactory:AddTRA_Attack2_Attacks(state, 3, 125, 0.04)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA004", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
