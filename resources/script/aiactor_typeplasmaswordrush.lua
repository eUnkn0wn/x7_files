...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypePlasmaSwordRush_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
...
function TypePlasmaSwordRush_CostumeSetting()
...
function TypePlasmaSwordRush_WeaponSetting()
  AIActor:SetWeapon(2000001, 0)
end
function TypePlasmaSwordRush_AIActorSetting()
  ...
  TypePlasmaSwordRush_AddDeathAIActorState()
  TypePlasmaSwordRush_AddNormalAIActorState()
  TypePlasmaSwordRush_AddRunAIActorState()
  TypePlasmaSwordRush_AddDamageAIActorState()
  TypePlasmaSwordRush_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypePlasmaSwordRush_AddNormalAIActorState()
...
function TypePlasmaSwordRush_AddRunAIActorState()
...
function TypePlasmaSwordRush_AddDamageAIActorState()
...
function TypePlasmaSwordRush_AddAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(750, 1250, false, false, 2, true)
  StateFactory:AddPlasmaSwordRushAttacks(state, 7, 800)
  state:RegisterSound("Resources/Sound/voice_girl_attack_3.ogg", "Bip01", 0, 5000)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("B0000", 0, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("B0001", 800, 0, 1000, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_DELAY, animParam)
end
function TypePlasmaSwordRush_AddDeathAIActorState()
