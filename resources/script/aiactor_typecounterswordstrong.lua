...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeCounterSwordStrong_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
...
function TypeCounterSwordStrong_CostumeSetting()
...
function TypeCounterSwordStrong_WeaponSetting()
  AIActor:SetWeapon(2000002, 0)
end
function TypeCounterSwordStrong_AIActorSetting()
  ...
  TypeCounterSwordStrong_AddDeathAIActorState()
  TypeCounterSwordStrong_AddNormalAIActorState()
  TypeCounterSwordStrong_AddRunAIActorState()
  TypeCounterSwordStrong_AddDamageAIActorState()
  TypeCounterSwordStrong_AddAttack1AIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeCounterSwordStrong_AddNormalAIActorState()
...
function TypeCounterSwordStrong_AddRunAIActorState()
...
function TypeCounterSwordStrong_AddDamageAIActorState()
...
function TypeCounterSwordStrong_AddAttack1AIActorState()
  ...
  state:RegisterSound("Resources/Sound/voice_girl_attack_3.ogg", "Bip01", 0, 2500)
  ...
  StateFactory:AddCounterSwordCounterAttacks(state, 15, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
...
function TypeCounterSwordStrong_AddDeathAIActorState()
