...
function TypeTRC_CostumeSetting()
end
function TypeTRC_WeaponSetting()
end
function TypeTRC_AIActorSetting()
  TypeTRC_AddDeathAIActorState()
  TypeTRC_AddNormalAIActorState()
  TypeTRC_AddRunAIActorState()
  TypeTRC_AddDamageAIActorState()
  TypeTRC_AddAttackAIActorState()
  Common_AddIdleState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeTRC_AddDeathAIActorState()
...
function TypeTRC_AddNormalAIActorState()
...
function TypeTRC_AddRunAIActorState()
...
function TypeTRC_AddDamageAIActorState()
...
function TypeTRC_AddAttackAIActorState()
  ...
  StateFactory:AddTRB_Attacks(state, 10, 125, 0.04)
