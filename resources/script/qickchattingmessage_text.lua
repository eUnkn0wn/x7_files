...
index = 0
MESSAGETYPE_NON = index
index = index + 1
MESSAGETYPE_ATTACK = index
index = index + 1
MESSAGETYPE_DEFENSE = index
index = index + 1
MESSAGETYPE_TEXT = index
index = index + 1
MESSAGETYPE_MALE_SOUND = index
index = index + 1
MESSAGETYPE_FEMALE_SOUND = index
index = index + 1
ClearStringTable()
