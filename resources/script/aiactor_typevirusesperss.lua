...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeVirusEsperSS_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
...
function TypeVirusEsperSS_CostumeSetting()
  AIActor:SetCostume(1001043, 0)
  AIActor:SetCostume(1010017, 0)
  AIActor:SetCostume(1021044, 0)
  AIActor:SetCostume(1031044, 0)
  AIActor:SetCostume(1041044, 0)
  AIActor:SetCostume(1051044, 0)
  AIActor:SetCostume(1061044, 0)
end
function TypeVirusEsperSS_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeVirusEsperSS_AIActorSetting()
  ...
  TypeVirusEsperSS_AddDeathAIActorState()
  TypeVirusEsperSS_AddNormalAIActorState()
  TypeVirusEsperSS_AddRunAIActorState()
  TypeVirusEsperSS_AddDamageAIActorState()
  TypeVirusEsperSS_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeVirusEsperSS_AddNormalAIActorState()
...
function TypeVirusEsperSS_AddRunAIActorState()
...
function TypeVirusEsperSS_AddDamageAIActorState()
...
function TypeVirusEsperSS_AddAttackAIActorState()
  ...
  TypeVirusEsperSS_AddAttackAILowerStates(state)
end
function TypeVirusEsperSS_AddAttackAILowerStates(state)
  TypeVirusEsperSS_AddAttackNormalLowerState(state)
  TypeVirusEsperSS_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeVirusEsperSS_AddAttackNormalLowerState(state)
...
function TypeVirusEsperSS_AddAttackRunLowerState(state)
...
function TypeVirusEsperSS_AddDeathAIActorState()
