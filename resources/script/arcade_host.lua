...
function Update()
  ...
  Print(string.format("\n \161\218\161\218\161\218\190\247\181\165\192\204\198\174\189\199\199\224 time = %d Phase = %d\161\218\161\218\161\218", u32AccumulateTime, u32PhaseCheck))
  Arcade:Print(string.format("\n \161\218\161\218\161\218\190\247\181\165\192\204\198\174\189\199\199\224 CS=%d/CP=%d\161\218\161\218\161\218", u32StageID, u32PhaseCheck))
...
function RemoveAIActor()
  ...
  if 1 <= u32StageID then
    ...
    if u32StageID == 1 then
      ...
      Print(string.format("\189\186\197\215\192\204\193\2461 13\191\161\188\173 \195\223\176\161\183\206 %d \184\182\184\174 \193\168 ", MonsterRespawnCalcu))
      Print(string.format("\189\186\197\215\192\204\193\2461 6\191\161\188\173 \195\223\176\161\183\206 %d \184\182\184\174 \193\168 ", MonsterRespawnCalcu1))
    ...
    if u32StageID == 7 then
      ...
      RandomItemSpawn("SUICIDE_ROBOT", 30, false, 8, 10, 0.05, 0.2, true)
      RandomItemSpawn("MASTERTR_A01", 200, false, 9, 9, 0.05, 0.2, true)
...
function OnMissionInfoClose()
  Arcade:Print(string.format("\185\204\188\199 \197\216\189\186\198\174 \195\226\183\194 \193\190\183\225"))
...
function TriggerNotifyID()
  Arcade:Print(string.format("\198\174\184\174\176\197\179\235\198\188\189\199\199\224\181\200\180\217."))
...
function PhaseTimer(PhaseTimer)
  Arcade:Print(string.format("\198\228\192\204\193\238\197\184\192\204\184\211\189\199\199\224"))
  local myCurrentTime
  ...
  elseif u32PastTime ~= 0 and myCurrentTime > u32PastTime + PhaseTimer then
    Arcade:Print(string.format("\n\162\205\162\205\198\228\192\204\193\238\197\184\192\204\184\211 \191\185\190\224\189\195\176\163 \179\161\162\205\162\205"))
...
function Stage01()
  Arcade:Print(string.format("\189\186\197\215\192\204\193\2461 \189\199\199\224"))
  local Difficult = Arcade:GetDifficult()
  u32TRobotA = HostArg:GetLU32("TR_A01")
...
function Stage04()
  ...
  elseif u32PhaseCheck == 3 then
    ...
    u32VirusEsperP = HostArg:GetLU32("INFECTED_ESPER_P")
    Arcade:Print(string.format("\195\202\177\226\200\173"))
    PhaseAdd()
  elseif u32PhaseCheck == 5 then
...
function Stage06()
  ...
  u32Virus = HostArg:GetLU32("VIRUS")
  Arcade:Print(string.format("\n\161\218 \161\218 \161\218 \161\218 VIRUS \184\238\184\182\184\174? %d \161\218 \161\218 \161\218 \161\218 \n", u32Virus))
  if u32PhaseCheck == 0 then
