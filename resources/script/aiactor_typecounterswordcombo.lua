...
function TypeCounterSwordCombo_AddAttack1AIActorState()
  ...
  state:RegisterSound("Resources/Sound/Acade/virus_voice_girl_attack_5.ogg", "Bip01", 0, 2500)
  state:RegisterGhostTrail("GhostTrail_counter_sword_01", 50, 600)
  StateFactory:AddCounterSword1Attacks(state, 7, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
...
function TypeCounterSwordCombo_AddAttack2AIActorState()
  ...
  state:RegisterSound("Resources/Sound/Acade/virus_voice_girl_attack_2.ogg", "Bip01", 0, 2500)
  state:RegisterGhostTrail("GhostTrail_counter_sword_01", 50, 600)
  StateFactory:AddCounterSword2Attacks(state, 9, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_DELAY = index
...
function TypeCounterSwordCombo_AddAttack3AIActorState()
  ...
  state:RegisterSound("Resources/Sound/Acade/virus_voice_girl_attack_1.ogg", "Bip01", 0, 2500)
  state:RegisterGhostTrail("GhostTrail_counter_sword_01", 50, 600)
  StateFactory:AddCounterSword3Attacks(state, 11, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_DELAY = index
...
function TypeCounterSwordCombo_AddAttack4AIActorState()
  ...
  state:RegisterSound("Resources/Sound/Acade/virus_voice_girl_attack_4.ogg", "Bip01", 0, 2500)
