...
function TypeSMG_Stand_CostumeSetting()
...
function TypeSMG_Stand_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeSMG_Stand_AIActorSetting()
  ...
  TypeSMG_Stand_AddDeathAIActorState()
  TypeSMG_Stand_AddNormalAIActorState()
  TypeSMG_Stand_AddRunAIActorState()
  TypeSMG_Stand_AddDamageAIActorState()
  TypeSMG_Stand_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeSMG_Stand_AddNormalAIActorState()
...
function TypeSMG_Stand_AddRunAIActorState()
...
function TypeSMG_Stand_AddDamageAIActorState()
...
function TypeSMG_Stand_AddAttackAIActorState()
  ...
  TypeSMG_Stand_AddAttackAILowerStates(state)
end
function TypeSMG_Stand_AddAttackAILowerStates(state)
  TypeSMG_Stand_AddAttackNormalLowerState(state)
  TypeSMG_Stand_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeSMG_Stand_AddAttackNormalLowerState(state)
...
function TypeSMG_Stand_AddAttackRunLowerState(state)
...
function TypeSMG_Stand_AddDeathAIActorState()
