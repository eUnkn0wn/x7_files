...
local StrikerActor
local BallResetLength = 5000
function Initialize(BTCAIActor)
  BTCAIActor:SetAttackTypeInfo(0, BTCAIACTOR_ATTACK_MELEE, 500, 100, 100, 1)
  BTCAIActor:SetAttackTypeInfo(1, BTCAIACTOR_ATTACK_HEAL, 2000, 100, 100, 1)
  BTCAIActor:SetAttackTypeInfo(2, BTCAIACTOR_ATTACK_RANGE, 1200, 100, 100, 1)
...
function Update(timeDelta, BTCAIActor)
  ...
  elseif true == BTCTDHelper:IsBallOwner(StrikerActor) then
