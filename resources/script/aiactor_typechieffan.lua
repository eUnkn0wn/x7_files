...
function TypeChiefFan_CostumeSetting()
  AIActor:SetCostume(1000005, 4)
  AIActor:SetCostume(1010010, 0)
  AIActor:SetCostume(1020018, 4)
  AIActor:SetCostume(1030017, 4)
  AIActor:SetCostume(1040017, 0)
  AIActor:SetCostume(1050017, 0)
  AIActor:SetCostume(1060019, 0)
end
function TypeChiefFan_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeChiefFan_AIActorSetting()
  ...
  TypeChiefFan_AddDeathAIActorState()
  TypeChiefFan_AddNormalAIActorState()
  TypeChiefFan_AddRunAIActorState()
  TypeChiefFan_AddDamageAIActorState()
  TypeChiefFan_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeChiefFan_AddNormalAIActorState()
...
function TypeChiefFan_AddRunAIActorState()
...
function TypeChiefFan_AddDamageAIActorState()
...
function TypeChiefFan_AddAttackAIActorState()
  ...
  StateFactory:AddSMGNormalAttacks(state, 7, 125, 0.04)
  ...
  TypeChiefFan_AddAttackAILowerStates(state)
end
function TypeChiefFan_AddAttackAILowerStates(state)
  TypeChiefFan_AddAttackNormalLowerState(state)
  TypeChiefFan_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeChiefFan_AddAttackNormalLowerState(state)
...
function TypeChiefFan_AddAttackRunLowerState(state)
...
function TypeChiefFan_AddDeathAIActorState()
