...
function TypeBossVirus_Init()
  ...
  AIActor:SetBaseMoveSpeedMax(1400)
...
function TypeBossVirus_AddNormalAIActorState()
  ...
  animParam:SetAnim("MM012", 0, 1000, 0, true, 1, false)
...
function TypeBossVirus_AddRunAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM005", 0, 1000, 0, true, 1, false)
...
function TypeBossVirus_AddDamageAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM004", 0, 0, 0, true, 1, true)
...
function TypeBossVirus_AddLeftKnuckleAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_NORMAL, AASTATE_NORMAL)
  state:SetNextStateID(AAINPUT_DEATH, AASTATE_DEATH)
  state:InitAttackAIActorState(1500, 0, false, false, 0, true)
  StateFactory:AddBossVirus_LeftKnuckleAttacks(state, 600, 25, 1200)
  state:RegisterSound("Resources/Sound/Acade/bossvirus_leftattack.ogg", "Bip01", 0, 2500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM001", 0, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeBossVirus_AddRightKnuckleAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DEATH, AASTATE_DEATH)
  state:InitAttackAIActorState(1500, 0, false, false, 0, true)
  StateFactory:AddBossVirus_RightKnuckleAttacks(state, 600, 30, 1200)
  state:RegisterSound("Resources/Sound/Acade/bossvirus_rightattack.ogg", "Bip01", 0, 2500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM002", 0, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeBossVirus_AddSmokeAttackAIActorState()
  ...
  StateFactory:AddBossVirus_SmokeAttacks(state, 3500, 20, 8000)
  state:RegisterSequence(1, "Resources/Effects/pve_boss_att04.seq", "", 1, 0)
  state:RegisterSound("Resources/Sound/Acade/bossvirus_smokeattack.ogg", "Bip01", 0, 2500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM008", 0, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeBossVirus_AddExplosionAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_NORMAL, AASTATE_NORMAL)
  state:SetNextStateID(AAINPUT_DEATH, AASTATE_DEATH)
  state:InitAttackAIActorState(4500, 0, false, false, 0, true)
  state:RegisterSequence(1, "Resources/Effects/pve_boss_att03.seq", "", 1, 0)
  state:RegisterSound("Resources/Sound/Acade/bossvirus_boom.ogg", "Bip01", 0, 2500)
  state:EnableCameraShake(true, true, 0)
  state:SetCameraShakeFactor1(3400, 0, 10)
  state:SetCameraShakeFactor2(1.7, 2.3, 3000, 10000)
  state:SetAttractiveData(500, 2500, 2300, 0, 10000)
  StateFactory:AddBossVirus_ExplosionAttacks(state, 3200, 60, 2800)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM009", 0, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeBossVirus_AddStunAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_NORMAL, AASTATE_NORMAL)
  state:SetNextStateID(AAINPUT_DEATH, AASTATE_DEATH)
  state:InitAttackAIActorState(4000, 0, false, false, 0, true)
  StateFactory:AddBossVirus_StunAttacks(state, 500, 20, 1000)
  StateFactory:AddBossVirus_StunAttacks(state, 1100, 20, 1000)
  StateFactory:AddBossVirus_StunAttacks(state, 1800, 20, 1000)
  StateFactory:AddBossVirus_StunAttacks(state, 2400, 20, 1000)
  StateFactory:AddBossVirus_StunAttacks(state, 3100, 20, 1000)
  state:RegisterSound("Resources/Sound/Acade/bossvirus_comboattack.ogg", "Bip01", 0, 2500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM010", 0, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeBossVirus_AddSummonAIActorState()
  ...
  state:SetNextStateID(AAINPUT_NORMAL, AASTATE_NORMAL)
  state:SetNextStateID(AAINPUT_DEATH, AASTATE_DEATH)
  state:RegisterSound("Resources/Sound/Acade/bossvirus_ summons.ogg", "Bip01", 0, 2500)
  state:Init(2000)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM006", 0, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
...
function TypeBossVirus_AddDeathAIActorState()
  ...
  state:RegisterSound("Resources/Sound/Acade/bossvirus_death.ogg", "Bip01", 0, 2500)
end
function TypeBossVirus_AddStunAIActorState()
  ...
  state:RegisterSound("Resources/Sound/Acade/bossvirus_stun.ogg", "Bip01", 0, 2500)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM004", 0, 0, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_PRECEDING, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MM011", 0, 1000, 0, true, 1, true)
