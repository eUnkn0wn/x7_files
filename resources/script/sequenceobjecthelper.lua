function SequenceObjectHelper_Run()
  local index = 0
  SEQPLAYER_SEC_1 = index
  index = index + 1
  SEQPLAYER_SEC_2 = index
  index = index + 1
  SEQPLAYER_SEC_3 = index
  index = index + 1
  SEQPLAYER_SEC_4 = index
  index = index + 1
  SEQPLAYER_SEC_5 = index
  index = index + 1
  SEQPLAYER_SEC_6 = index
  index = index + 1
  SEQPLAYER_SEC_7 = index
  index = index + 1
  SEQPLAYER_SEC_8 = index
  index = index + 1
  SEQPLAYER_SEC_9 = index
  index = index + 1
  SEQPLAYER_SEC_10 = index
  index = index + 1
  SEQPLAYER_SEC_20 = index
  index = index + 1
  SEQPLAYER_SEC_30 = index
  index = index + 1
  SEQPLAYER_MIN_1 = index
  index = index + 1
  SEQPLAYER_MIN_2 = index
  index = index + 1
  SEQPLAYER_MIN_3 = index
  index = index + 1
  SEQPLAYER_MIN_5 = index
  index = index + 1
  SEQPLAYER_ROUND = index
  index = index + 1
  SEQPLAYER_SL_ROUND = index
  index = index + 1
  SEQPLAYER_ROUND_NOTICE = index
  index = index + 1
  SEQPLAYER_RESETROUND_NOTICE = index
  index = index + 1
  SEQPLAYER_SL_RESETROUND_NOTICE = index
  index = index + 1
  SEQPLAYER_TIMEOVER = index
  index = index + 1
  SEQPLAYER_SET_WIN_DEATHMATCH = index
  index = index + 1
  SEQPLAYER_SET_LOSE_DEATHMATCH = index
  index = index + 1
  SEQPLAYER_SET_WIN_TOUCHDOWN = index
  index = index + 1
  SEQPLAYER_SET_LOSE_TOUCHDOWN = index
  index = index + 1
  SEQPLAYER_SET_WIN_SURVIVAL = index
  index = index + 1
  SEQPLAYER_SET_LOSE_SURVIVAL = index
  index = index + 1
  SEQPLAYER_SET_WIN_MISSION = index
  index = index + 1
  SEQPLAYER_SET_LOSE_MISSION = index
  index = index + 1
  SEQPLAYER_SET_WIN_ARCADE = index
  index = index + 1
  SEQPLAYER_SET_LOSE_ARCADE = index
  index = index + 1
  SEQPLAYER_SET_WIN_SLAUGHTER = index
  index = index + 1
  SEQPLAYER_SET_LOSE_SLAUGHTER = index
  index = index + 1
  SEQPLAYER_FOOTBALL_BALL_RESET = index
  index = index + 1
  SEQPLAYER_FOOTBALL_GETBALL_ME = index
  index = index + 1
  SEQPLAYER_FOOTBALL_GETBALL_ALLY = index
  index = index + 1
  SEQPLAYER_FOOTBALL_GETBALL_ENEMY = index
  index = index + 1
  SEQPLAYER_FOOTBALL_LOSTBALL_ALLY = index
  index = index + 1
  SEQPLAYER_FOOTBALL_LOSTBALL_ENEMY = index
  index = index + 1
  SEQPLAYER_SCORE_ALLY = index
  index = index + 1
  SEQPLAYER_SCORE_ENEMY = index
  index = index + 1
  SEQPLAYER_SCORE_DRAW = index
  index = index + 1
  SEQPLAYER_LEAD_ALLY = index
  index = index + 1
  SEQPLAYER_LEAD_ENEMY = index
  index = index + 1
  SEQPLAYER_KILL_ENEMY = index
  index = index + 1
  SEQPLAYER_MISSOIN_BLAST_OBJECT = index
  index = index + 1
  SEQPLAYER_KILL_COMBO1 = index
  index = index + 1
  SEQPLAYER_KILL_COMBO2 = index
  index = index + 1
  SEQPLAYER_KILL_COMBO3 = index
  index = index + 1
  SEQPLAYER_KILL_COMBO4 = index
  index = index + 1
  SEQPLAYER_KILL_COMBO5 = index
  index = index + 1
  SEQPLAYER_KILL_COMBO6 = index
  index = index + 1
  SEQPLAYER_KILL_COMBO7 = index
  index = index + 1
  SEQPLAYER_KILL_COMBO8 = index
  index = index + 1
  SEQPLAYER_SLAUGHTERER_WIN = index
  index = index + 1
  SEQPLAYER_SLAUGHTERER_DEFEAT = index
  index = index + 1
  SEQPLAYER_INNOCENT_PEOPLE_WIN = index
  index = index + 1
  SEQPLAYER_INNOCENT_PEOPLE_DEFEAT = index
  index = index + 1
  SEQPLAYER_INNOCENT_SLAUGHTER_1 = index
  index = index + 1
  SEQPLAYER_INNOCENT_SLAUGHTER_2 = index
  index = index + 1
  SEQPLAYER_YOU_ARE_THE_KINGPLAYER = index
  index = index + 1
  SEQPLAYER_YOU_KILLED_THE_PLAYER = index
  index = index + 1
  SEQPLAYER_YOU_KILLED_THE_KINGPLAYER = index
  index = index + 1
  SEQPLAYER_YOU_KILLED_THE_CAPTAIN_PLYAER = index
  index = index + 1
  SEQPLAYER_YOU_DOMINATION_ROUND_WIN = index
  index = index + 1
  SEQPLAYER_YOU_DOMINATION_ROUND_LOSE = index
  index = index + 1
  SEQPLAYER_EVENT_PRESENT_GET = index
  index = index + 1
  SEQPLAYER_EVENT_CAPTURE_FLAG = index
  index = index + 1
  SEQPLAYER_WARFARE_AI_DAMAGED_NOTIFY = index
  index = index + 1
  SEQPLAYER_WARFARE_AIKILL_ALLY = index
  index = index + 1
  SEQPLAYER_WARFARE_AIKILL_ENEMY = index
  index = index + 1
  SEQPLAYER_WARFARE_AI_INCREASE_HP = index
  index = index + 1
  SEQPLAYER_ARENA_PREPARE_ROUND = index
  index = index + 1
  SEQPLAYER_ARENA_ROUND_READY = index
  index = index + 1
  SEQPLAYER_ARENA_ROUND_START = index
  index = index + 1
  SEQPLAYER_ARENA_ROUND_WIN = index
  index = index + 1
  SEQPLAYER_ARENA_ROUND_LOSE = index
  index = index + 1
  SEQPLAYER_ARENA_ROUND_DRAW = index
  index = index + 1
  SEQPLAYER_ARENA_STOPPED_WIN = index
  index = index + 1
  SEQPLAYER_ARENA_FULL_CHARGE = index
  index = index + 1
  SEQPLAYER_ARENA_LEADER_SHOWDOWN = index
  index = index + 1
  SEQPLAYER_ARENA_ALPHA_SPATTACK_ALLY = index
  index = index + 1
  SEQPLAYER_ARENA_ALPHA_SPHEAL_ALLY = index
  index = index + 1
  SEQPLAYER_ARENA_ALPHA_SPATTACK_ENEMY = index
  index = index + 1
  SEQPLAYER_ARENA_ALPHA_SPHEAL_ENEMY = index
  index = index + 1
  SEQPLAYER_ARENA_BETA_SPATTACK_ALLY = index
  index = index + 1
  SEQPLAYER_ARENA_BETA_SPHEAL_ALLY = index
  index = index + 1
  SEQPLAYER_ARENA_BETA_SPATTACK_ENEMY = index
  index = index + 1
  SEQPLAYER_ARENA_BETA_SPHEAL_ENEMY = index
  index = index + 1
  SEQPLAYER_ARENA_SUPPORT_HELP = index
  index = index + 1
  SEQPLAYER_TOTAL = index
  index = index + 1
  OPTION_NULL = 0
  OPTION_GET_RANDOM = 1
  OPTION_MATCH_INDEX = 2
  UNIQUEKEY_NOT_USE = 0
