...
function TypeVirusTeajo_CostumeSetting()
  AIActor:SetCostume(1000014, 0)
  AIActor:SetCostume(1010017, 0)
  AIActor:SetCostume(1020065, 0)
  AIActor:SetCostume(1030037, 0)
  AIActor:SetCostume(1040033, 0)
  AIActor:SetCostume(1050029, 0)
  AIActor:SetCostume(1060000, 0)
end
function TypeVirusTeajo_WeaponSetting()
  AIActor:SetWeapon(2000002, 2)
end
function TypeVirusTeajo_AIActorSetting()
  ...
  TypeVirusTeajo_AddDeathAIActorState()
  TypeVirusTeajo_AddNormalAIActorState()
  TypeVirusTeajo_AddRunAIActorState()
  TypeVirusTeajo_AddDamageAIActorState()
  TypeVirusTeajo_AddAttack1AIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeVirusTeajo_AddNormalAIActorState()
...
function TypeVirusTeajo_AddRunAIActorState()
...
function TypeVirusTeajo_AddDamageAIActorState()
...
function TypeVirusTeajo_AddAttack1AIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(1000, 500, false, false, 0, true)
  state:RegisterSound("Resources/Sound/Acade/virus_voice_man_attack_3.ogg", "Bip01", 0, 2500)
  ...
  StateFactory:AddCounterSwordCounterAttacks(state, 30, 600)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0030", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0031", 0, 1000, 1000, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_DELAY, animParam)
end
function TypeVirusTeajo_AddDeathAIActorState()
