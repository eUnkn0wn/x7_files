...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeRobotRoundAttack_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
...
function TypeRobotRoundAttack_CostumeSetting()
...
function TypeRobotRoundAttack_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeRobotRoundAttack_AIActorSetting()
  ...
  TypeRobotRoundAttack_AddDeathAIActorState()
  TypeRobotRoundAttack_AddNormalAIActorState()
  TypeRobotRoundAttack_AddRunAIActorState()
  TypeRobotRoundAttack_AddDamageAIActorState()
  TypeRobotRoundAttack_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeRobotRoundAttack_AddNormalAIActorState()
...
function TypeRobotRoundAttack_AddRunAIActorState()
...
function TypeRobotRoundAttack_AddDamageAIActorState()
...
function TypeRobotRoundAttack_AddAttackAIActorState()
  ...
  TypeRobotRoundAttack_AddAttackAILowerStates(state)
end
function TypeRobotRoundAttack_AddAttackAILowerStates(state)
  TypeRobotRoundAttack_AddAttackNormalLowerState(state)
  TypeRobotRoundAttack_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeRobotRoundAttack_AddAttackNormalLowerState(state)
...
function TypeRobotRoundAttack_AddAttackRunLowerState(state)
...
function TypeRobotRoundAttack_AddDeathAIActorState()
