...
function TypeChiefSword_CostumeSetting()
  AIActor:SetCostume(1000006, 4)
  AIActor:SetCostume(1010010, 0)
  AIActor:SetCostume(1020018, 2)
  AIActor:SetCostume(1030017, 2)
  AIActor:SetCostume(1040017, 0)
  AIActor:SetCostume(1050017, 0)
  AIActor:SetCostume(1060013, 0)
end
function TypeChiefSword_WeaponSetting()
  AIActor:SetWeapon(2000001, 0)
end
function TypeChiefSword_AIActorSetting()
  ...
  TypeChiefSword_AddDeathAIActorState()
  TypeChiefSword_AddNormalAIActorState()
  TypeChiefSword_AddRunAIActorState()
  TypeChiefSword_AddDamageAIActorState()
  TypeChiefSword_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeChiefSword_AddNormalAIActorState()
...
function TypeChiefSword_AddRunAIActorState()
...
function TypeChiefSword_AddDamageAIActorState()
...
function TypeChiefSword_AddAttackAIActorState()
  ...
  StateFactory:AddPlasmaSwordStrongAttacks(state, 10, 800)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
...
function TypeChiefSword_AddDeathAIActorState()
