...
function TypeVirusClose_CostumeSetting()
  AIActor:SetCostume(1001043, 0)
  AIActor:SetCostume(1010017, 0)
  AIActor:SetCostume(1021043, 0)
  AIActor:SetCostume(1031043, 0)
  AIActor:SetCostume(1041043, 0)
  AIActor:SetCostume(1051043, 0)
  AIActor:SetCostume(1061043, 0)
end
function TypeVirusClose_WeaponSetting()
  AIActor:SetWeapon(2000001, 1)
end
function TypeVirusClose_AIActorSetting()
  ...
  TypeVirusClose_AddDeathAIActorState()
  TypeVirusClose_AddNormalAIActorState()
  TypeVirusClose_AddRunAIActorState()
  TypeVirusClose_AddDamageAIActorState()
  TypeVirusClose_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeVirusClose_AddNormalAIActorState()
  ...
  animParam:SetAnim("A0013", 0, 1000, 0, true, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeVirusClose_AddRunAIActorState()
...
function TypeVirusClose_AddDamageAIActorState()
...
function TypeVirusClose_AddAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(1000, 0, false, false, 0, true)
  state:RegisterGhostTrail("GhostTrail_two_hand_sword_01", 50, 350)
  StateFactory:AddPlasmaSwordStrongAttacks(state, 10, 450)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("A0000", 900, 200, 500, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeVirusClose_AddDeathAIActorState()
