...
local TankerActor
local HealActorSearchRange = 5000
local BallResetLength = 5000
function Initialize(BTCAIActor)
  BTCAIActor:SetAttackTypeInfo(0, BTCAIACTOR_ATTACK_RANGE, 2000, 100, 100, 1)
  BTCAIActor:SetAttackTypeInfo(1, BTCAIACTOR_ATTACK_HEAL, 1800, 100, 100, 1)
  BTCAIActor:SetAttackTypeInfo(2, BTCAIACTOR_ATTACK_HEAL, 2000, 100, 100, 1)
