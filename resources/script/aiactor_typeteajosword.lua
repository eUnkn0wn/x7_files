...
function TypeTeajoSword_CostumeSetting()
  AIActor:SetCostume(1000001, 0)
  AIActor:SetCostume(1010015, 0)
  AIActor:SetCostume(1020032, 5)
  AIActor:SetCostume(1030033, 0)
  AIActor:SetCostume(1040033, 0)
  AIActor:SetCostume(1050023, 1)
  AIActor:SetCostume(1060025, 0)
end
function TypeTeajoSword_WeaponSetting()
  AIActor:SetWeapon(2000002, 0)
end
function TypeTeajoSword_AIActorSetting()
  ...
  TypeTeajoSword_AddDeathAIActorState()
  TypeTeajoSword_AddNormalAIActorState()
  TypeTeajoSword_AddRunAIActorState()
  TypeTeajoSword_AddDamageAIActorState()
  TypeTeajoSword_AddAttack1AIActorState()
  TypeTeajoSword_AddAttack2AIActorState()
  TypeTeajoSword_AddAttack3AIActorState()
  TypeTeajoSword_AddAttack4AIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeTeajoSword_AddNormalAIActorState()
  ...
  animParam:SetAnim("R0004", 0, 1000, 0, true, 1, false)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeTeajoSword_AddRunAIActorState()
...
function TypeTeajoSword_AddDamageAIActorState()
...
function TypeTeajoSword_AddAttack1AIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(800, 250, false, false, 1, true)
  state:RegisterSound("Resources/Sound/voice_man_attack_5.ogg", "Bip01", 0, 2500)
  state:RegisterGhostTrail("GhostTrail_counter_sword_01", 50, 600)
  StateFactory:AddCounterSword1Attacks(state, 15, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_DELAY = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  index = index + 1
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0000", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0025", 0, 1000, 1000, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_DELAY, animParam)
end
function TypeTeajoSword_AddAttack2AIActorState()
  local state = StateFactory:GetAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(600, 400, false, false, 1, true)
  state:RegisterSound("Resources/Sound/voice_man_attack_2.ogg", "Bip01", 0, 2500)
  state:RegisterGhostTrail("GhostTrail_counter_sword_01", 50, 600)
  StateFactory:AddCounterSword2Attacks(state, 15, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_DELAY = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0001", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0026", 0, 1000, 1000, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_DELAY, animParam)
end
function TypeTeajoSword_AddAttack3AIActorState()
  local state = StateFactory:GetAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(800, 300, false, false, 1, true)
  state:RegisterSound("Resources/Sound/voice_man_attack_1.ogg", "Bip01", 0, 2500)
  state:RegisterGhostTrail("GhostTrail_counter_sword_01", 50, 600)
  StateFactory:AddCounterSword3Attacks(state, 15, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_DELAY = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0002", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0027", 0, 1000, 1000, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_DELAY, animParam)
end
function TypeTeajoSword_AddAttack4AIActorState()
  local state = StateFactory:GetAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(1150, 300, false, false, 1, true)
  state:RegisterSound("Resources/Sound/voice_man_attack_4.ogg", "Bip01", 0, 2500)
  state:RegisterGhostTrail("GhostTrail_counter_sword_01", 150, 1100)
  StateFactory:AddCounterSword4Attacks(state, 15, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_DELAY = index
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0003", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("R0028", 0, 1000, 1000, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_DELAY, animParam)
end
function TypeTeajoSword_AddDeathAIActorState()
