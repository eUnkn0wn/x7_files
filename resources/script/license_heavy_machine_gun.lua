...
index = index + 1
function OnHeavyMachineGunLicenseTest()
  TutorialSystem:SetTotalStage(2)
  OnSubMachineGunLicenseTestStep01()
  OnSubMachineGunLicenseTestStep02()
end
NI_START = 101
...
function OnSubMachineGunLicenseTestStep01()
  ...
  HeavyMachineGunLoad = TriggerPackage:GetItemDuplicator(0, 2020001, 0, 0)
  ...
  Text_ClearStep01 = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_CompleteTip02_off, 0, TXT_Weapon_HeavyMachinegGun_12, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  ...
  Dummy_ScoreCheck01 = TriggerPackage:GetTextViewerEx(50, 200, NI_SCORE_COMPLETED01, 0, TXT_Weapon_HeavyMachinegGun_07, "")
  Dummy_ScoreCheck02 = TriggerPackage:GetTextViewerEx(50, 220, NI_SCORE_COMPLETED02, 0, TXT_Weapon_HeavyMachinegGun_11, "")
  ...
  MessageBox_Step01 = TriggerPackage:GetStageChanger(TutorialSystem, 0, 1, 0, 5)
  Congraturation_Step01 = TriggerPackage:GetTutorialComplete(NI_CONGRATULATION)
  SubMachineGunLicense:Register(ActorSpawn)
  SubMachineGunLicense:Register(HeavyMachineGunLoad)
...
function OnSubMachineGunLicenseTestStep02()
  ...
  TriggerPackage:SetShowEventAlram(Timer_End, 470, 50, TXT_Weapon_HeavyMachinegGun_13, 1)
  ...
  Text_Step02Start = TriggerPackage:GetTextViewerExA(512, 250, NI_Start_Step02, NI_Text_Step02Start_off, TXT_Weapon_HeavyMachinegGun_14, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Step02Ready = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_Step02Start_off, NI_TestStart_Step02, TXT_Weapon_HeavyMachinegGun_15, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_TestStartStep02 = TriggerPackage:GetTextViewerExA(512, 250, NI_TestStart_Step02, NI_Text_TestStartStep02_OFF, TXT_Weapon_HeavyMachinegGun_16, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Test_TestGuide = TriggerPackage:GetTextViewerEx(600, 500, NI_TestStart_Step02, NI_Success, TXT_Weapon_HeavyMachinegGun_17, "Resources/GUI/New/TutorialImage_1.gui")
  Text_TestFail = TriggerPackage:GetTextViewerExA(512, 250, NI_Fail, NI_Text_TestFail_OFF, TXT_Weapon_HeavyMachinegGun_18, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_TestSuccess = TriggerPackage:GetTextViewerExA(512, 200, NI_Success, NI_Text_TestSuccess_OFF, TXT_Weapon_HeavyMachinegGun_19, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Blast_01 = TriggerPackage:GetTextViewerExA(512, 310, NI_Blast, NI_Text_Blast_01_off, TXT_Weapon_HeavyMachinegGun_20, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Blast_02 = TriggerPackage:GetTextViewerExA(512, 310, NI_Blast_01, NI_Text_Blast_02_off, TXT_Weapon_HeavyMachinegGun_21, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Blast_03 = TriggerPackage:GetTextViewerExA(512, 310, NI_Blast_02, NI_Text_Blast_03_off, TXT_Weapon_HeavyMachinegGun_22, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  ...
  BlastObject01 = TriggerPackage:GetDeployTutoBlastObject("blast2_box5", "eff_target_green.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 10, 5000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject01, 0, NI_Text_TestStartStep02_OFF, NI_Phase2, NI_Blast, 0)
  BlastObject02 = TriggerPackage:GetDeployTutoBlastObject("blast2_box10", "eff_target_yellow.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 30, 5000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject02, 0, NI_Text_TestStartStep02_OFF, NI_Phase2, NI_Blast_01, 0)
  BlastObject03 = TriggerPackage:GetDeployTutoBlastObject("blast2_box20", "eff_target_orange.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 60, 5000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject03, 0, NI_Text_TestStartStep02_OFF, NI_Phase2, NI_Blast_02, 0)
  BlastObject04 = TriggerPackage:GetDeployTutoBlastObject("blast2_box5_2", "eff_target_green.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 10, 5000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject04, 0, NI_Phase2, 0, NI_Blast, 0)
  BlastObject05 = TriggerPackage:GetDeployTutoBlastObject("blast2_box10_2", "eff_target_yellow.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 30, 5000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject05, 0, NI_Phase2, 0, NI_Blast_01, 0)
  BlastObject06 = TriggerPackage:GetDeployTutoBlastObject("blast2_box20_2", "eff_target_orange.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 60, 5000, 3, 0)
  ...
  ScoreMngBlast01 = TriggerPackage:GetScoreObserver(50, 200, NI_Blast, NI_Success, TXT_Weapon_HeavyMachinegGun_23, 30)
  ScoreMngBlast02 = TriggerPackage:GetScoreObserver(2000, 2000, NI_Blast, NI_Phase2, TXT_Weapon_HeavyMachinegGun_24, 15)
  ...
  InPutLicense = TriggerPackage:GetItemLicensed(NI_Success, 5)
  ...
  MessageBox_Step02 = TriggerPackage:GetStageChanger(TutorialSystem, 0, 1, NI_Text_TestFail_OFF, 5)
  MessageBox_Step03 = TriggerPackage:GetStageChanger(TutorialSystem, 0, 1, 0, 5)
  TestSuccessEnd = TriggerPackage:GetTutorialComplete(NI_Text_TestSuccess_OFF)
  TestStage:Register(SpawnHelper01)
  TestStage:Register(HeavyMachineGunLoad)
