...
function TypeTRA_Big_AddNormalAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA001", 0, 1000, 0, true, 1, true)
...
function TypeTRA_Big_AddRunAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA005", 0, 200, 0, true, 1, false)
...
function TypeTRA_Big_AddDamageAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA006", 0, 0, 0, true, 1, true)
...
function TypeTRA_Big_AddAttackAIActorState()
  ...
  StateFactory:AddTRA_Attacks(state, 800, 15, 500)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA003", 1500, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeTRA_Big_AddExplosionAttackAIActorState()
  ...
  state:InitAttackAIActorState(1500, 0, false, false, 1, true)
  StateFactory:AddTRABig_ExplosionAttacks(state, 800, 50, 1000)
...
function TypeTRA_Big_AddBlowActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA006", 0, 0, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_BEGIN, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA001", 0, 200, 0, true, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_MIDDLE, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("MA001", 0, 400, 0, false, 1, true)
