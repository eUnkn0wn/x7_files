...
index = index + 1
function OnCannonadeLicenseTest()
  TutorialSystem:SetTotalStage(2)
  OnCannonadeLicenseTestStep01()
  OnCannonadeLicenseTestStep02()
end
NI_START = 101
...
NI_RELOAD_Cannonade = 112
NI_CONGRATULATION = 113
LoadStringTable("Language/Script/tutorial_string_table.x7")
TXT_Weapon_Canonade_01 = GetString("TXT_Weapon_Canonade_01")
TXT_Weapon_Canonade_02 = GetString("TXT_Weapon_Canonade_02")
TXT_Weapon_Canonade_03 = GetString("TXT_Weapon_Canonade_03")
TXT_Weapon_Canonade_04 = GetString("TXT_Weapon_Canonade_04")
TXT_Weapon_Canonade_05 = GetString("TXT_Weapon_Canonade_05")
TXT_Weapon_Canonade_06 = GetString("TXT_Weapon_Canonade_06")
TXT_Weapon_Canonade_07 = GetString("TXT_Weapon_Canonade_07")
TXT_Weapon_Canonade_08 = GetString("TXT_Weapon_Canonade_08")
TXT_Weapon_Canonade_09 = GetString("TXT_Weapon_Canonade_09")
TXT_Weapon_Canonade_10 = GetString("TXT_Weapon_Canonade_10")
TXT_Weapon_Canonade_11 = GetString("TXT_Weapon_Canonade_11")
TXT_Weapon_Canonade_12 = GetString("TXT_Weapon_Canonade_12")
TXT_Weapon_Canonade_13 = GetString("TXT_Weapon_Canonade_13")
TXT_Weapon_Canonade_14 = GetString("TXT_Weapon_Canonade_14")
TXT_Weapon_Canonade_15 = GetString("TXT_Weapon_Canonade_15")
TXT_Weapon_Canonade_16 = GetString("TXT_Weapon_Canonade_16")
TXT_Weapon_Canonade_17 = GetString("TXT_Weapon_Canonade_17")
TXT_Weapon_Canonade_18 = GetString("TXT_Weapon_Canonade_18")
TXT_Weapon_Canonade_19 = GetString("TXT_Weapon_Canonade_19")
TXT_Weapon_Canonade_20 = GetString("TXT_Weapon_Canonade_20")
TXT_Weapon_Canonade_21 = GetString("TXT_Weapon_Canonade_21")
TXT_Weapon_Canonade_22 = GetString("TXT_Weapon_Canonade_22")
TXT_Weapon_Canonade_23 = GetString("TXT_Weapon_Canonade_23")
TXT_Weapon_Canonade_24 = GetString("TXT_Weapon_Canonade_24")
ClearStringTable()
function OnCannonadeLicenseTestStep01()
  CannonadeLicense = TutorialSystem:GetEmptyStage()
  ActorSpawn = TriggerPackage:GetSpawnHelper(SPAWN_TRIGGER_BEGIN, SPAWN_FOCUS_ACTOR, "trg_spawn_point_01", 0, 0, 0, 0, true)
  CannonadeLoad = TriggerPackage:GetItemDuplicator(0, 2030002, 0, 0)
  ...
  Text_Welcom01 = TriggerPackage:GetTextViewerExA(512, 250, NI_START, NI_Text_Welcom01_OFF, TXT_Weapon_Canonade_01, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Welcom02 = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_Welcom01_OFF, NI_Text_Welcom02_OFF, TXT_Weapon_Canonade_02, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Welcom03 = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_Welcom02_OFF, NI_Text_Welcom03_OFF, TXT_Weapon_Canonade_03, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Guide01 = TriggerPackage:GetTextViewerEx(600, 500, NI_Text_Welcom03_OFF, NI_SCORE_COMPLETED01, TXT_Weapon_Canonade_04, "Resources/GUI/New/TutorialImage_1.gui")
  Text_Guide02 = TriggerPackage:GetTextViewerEx(600, 500, NI_Text_CompleteTip01_off, NI_SCORE_COMPLETED02, TXT_Weapon_Canonade_05, "Resources/GUI/New/TutorialImage_1.gui")
  Text_CompleteTip01 = TriggerPackage:GetTextViewerExA(512, 300, NI_SCORE_COMPLETED01, NI_Text_CompleteTip01_off, TXT_Weapon_Canonade_08, "Resources/GUI/New/TutorialImage_0.gui", true, false)
  Text_CompleteTip02 = TriggerPackage:GetTextViewerExA(512, 300, NI_SCORE_COMPLETED02, NI_Text_CompleteTip02_off, TXT_Weapon_Canonade_09, "Resources/GUI/New/TutorialImage_0.gui", true, false)
  Text_ClearStep01 = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_CompleteTip02_off, 0, TXT_Weapon_Canonade_12, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  ScoreCheck01 = TriggerPackage:GetScoreObserver(50, 200, NI_ATTACK_1_Cannonade, NI_SCORE_COMPLETED01, TXT_Weapon_Canonade_06, 4)
  ScoreCheck02 = TriggerPackage:GetScoreObserver(50, 220, NI_RELOAD_Cannonade, NI_SCORE_COMPLETED02, TXT_Weapon_Canonade_10, 3)
  Dummy_ScoreCheck01 = TriggerPackage:GetTextViewerEx(50, 200, NI_SCORE_COMPLETED01, 0, TXT_Weapon_Canonade_07, "")
  Dummy_ScoreCheck02 = TriggerPackage:GetTextViewerEx(50, 220, NI_SCORE_COMPLETED02, 0, TXT_Weapon_Canonade_11, "")
  ActorAttackCheck01 = TriggerPackage:GetActorAttackObserver(NI_SCORE_COMPLETED01, NI_ATTACK_1_Cannonade, "ATTACK_1_CANNONADE", ScoreCheck01)
  ActorAttackCheck02 = TriggerPackage:GetActorAttackObserver(NI_SCORE_COMPLETED02, NI_RELOAD_Cannonade, "RELOAD_CANNONADE", ScoreCheck02)
  ...
  MessageBox_Step03 = TriggerPackage:GetStageChanger(TutorialSystem, 0, 1, 0, 7)
  Congraturation_Step01 = TriggerPackage:GetTutorialComplete(NI_CONGRATULATION)
  CannonadeLicense:Register(ActorSpawn)
  CannonadeLicense:Register(CannonadeLoad)
  CannonadeLicense:Register(Timer_TextStart)
  CannonadeLicense:Register(Timer_Text_Welcom01_Delay)
  CannonadeLicense:Register(Timer_Text_Welcom02_Delay)
  CannonadeLicense:Register(Timer_Text_Welcom03_Delay)
  CannonadeLicense:Register(Timer_Text_CompleteTip01_on)
  CannonadeLicense:Register(Timer_Text_CompleteTip01_off)
  CannonadeLicense:Register(Timer_Text_CompleteTip02_on)
  CannonadeLicense:Register(Timer_Text_CompleteTip02_off)
  CannonadeLicense:Register(Text_ClearStep01)
  CannonadeLicense:Register(KeyPermiter01)
  CannonadeLicense:Register(KeyPermiter02)
  CannonadeLicense:Register(KeyPermiter03)
  CannonadeLicense:Register(KeyPermiter04)
  CannonadeLicense:Register(KeyPermiter05)
  CannonadeLicense:Register(KeyPermiter06)
  CannonadeLicense:Register(Text_Welcom01)
  CannonadeLicense:Register(Text_Welcom02)
  CannonadeLicense:Register(Text_Welcom03)
  CannonadeLicense:Register(Text_Guide01)
  CannonadeLicense:Register(Text_Guide02)
  CannonadeLicense:Register(Text_CompleteTip01)
  CannonadeLicense:Register(Text_CompleteTip02)
  CannonadeLicense:Register(Dummy_ScoreCheck01)
  CannonadeLicense:Register(Dummy_ScoreCheck02)
  CannonadeLicense:Register(RegActorAttackCheck01)
  CannonadeLicense:Register(RegActorAttackCheck02)
  CannonadeLicense:Register(NarOK01)
  CannonadeLicense:Register(NarOK02)
  CannonadeLicense:Register(RegGateOpen_Step01)
  CannonadeLicense:Register(Arrow_Gate_off_01)
  CannonadeLicense:Register(Arrow_Gate_on_01)
  CannonadeLicense:Register(Congraturation_Step01)
  CannonadeLicense:Register(MessageBox_Step03)
  TutorialSystem:AddStage(0, CannonadeLicense)
end
NI_Start_Step02 = 201
...
NI_SayOne = 218
NI_Blast_03 = 219
function OnCannonadeLicenseTestStep02()
  ...
  TriggerPackage:SetShowEventAlram(Timer_End, 470, 50, TXT_Weapon_Canonade_13, 1)
  ...
  Text_Step02Start = TriggerPackage:GetTextViewerExA(512, 250, NI_Start_Step02, NI_Text_Step02Start_off, TXT_Weapon_Canonade_14, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Step02Ready = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_Step02Start_off, NI_TestStart_Step02, TXT_Weapon_Canonade_15, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_TestStartStep02 = TriggerPackage:GetTextViewerExA(512, 250, NI_TestStart_Step02, NI_Text_TestStartStep02_OFF, TXT_Weapon_Canonade_16, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Test_TestGuide = TriggerPackage:GetTextViewerEx(600, 500, NI_TestStart_Step02, NI_Success, TXT_Weapon_Canonade_17, "Resources/GUI/New/TutorialImage_1.gui")
  Text_TestFail = TriggerPackage:GetTextViewerExA(512, 250, NI_Fail, NI_Text_TestFail_OFF, TXT_Weapon_Canonade_18, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_TestSuccess = TriggerPackage:GetTextViewerExA(512, 200, NI_Success, NI_Text_TestSuccess_OFF, TXT_Weapon_Canonade_19, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Blast_01 = TriggerPackage:GetTextViewerExA(512, 310, NI_Blast, NI_Text_Blast_01_off, TXT_Weapon_Canonade_20, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Blast_02 = TriggerPackage:GetTextViewerExA(512, 310, NI_Blast_01, NI_Text_Blast_02_off, TXT_Weapon_Canonade_21, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Blast_03 = TriggerPackage:GetTextViewerExA(512, 310, NI_Blast_02, NI_Text_Blast_03_off, TXT_Weapon_Canonade_22, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  ...
  BlastObject01 = TriggerPackage:GetDeployTutoBlastObject("blast2_box5", "eff_target_green.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 30, 8000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject01, 0, NI_Text_TestStartStep02_OFF, NI_Phase2, NI_Blast, 0)
  BlastObject02 = TriggerPackage:GetDeployTutoBlastObject("blast2_box10", "eff_target_yellow.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 50, 8000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject02, 0, NI_Text_TestStartStep02_OFF, NI_Phase2, NI_Blast_01, 0)
  BlastObject03 = TriggerPackage:GetDeployTutoBlastObject("blast2_box20", "eff_target_orange.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 100, 8000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject03, 0, NI_Text_TestStartStep02_OFF, NI_Phase2, NI_Blast_02, 0)
  BlastObject04 = TriggerPackage:GetDeployTutoBlastObject("blast2_box5_2", "eff_target_green.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 30, 8000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject04, 0, NI_Phase2, 0, NI_Blast, 0)
  BlastObject05 = TriggerPackage:GetDeployTutoBlastObject("blast2_box10_2", "eff_target_yellow.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 50, 8000, 3, 0)
  TriggerPackage:SetupDeployTutoBlastObject(BlastObject05, 0, NI_Phase2, 0, NI_Blast_01, 0)
  BlastObject06 = TriggerPackage:GetDeployTutoBlastObject("blast2_box20_2", "eff_target_orange.seq", "wall_destroy_steel.ogg", "wall_create.ogg", 100, 8000, 3, 0)
  ...
  ScoreMngBlast01 = TriggerPackage:GetScoreObserver(50, 200, NI_Blast_03, NI_Success, TXT_Weapon_Canonade_23, 15)
  ScoreMngBlast02 = TriggerPackage:GetScoreObserver(2000, 2000, NI_Blast_03, NI_Phase2, TXT_Weapon_Canonade_24, 10)
  ...
  InPutLicense = TriggerPackage:GetItemLicensed(NI_Success, 7)
  ...
  MessageBox_Step02 = TriggerPackage:GetStageChanger(TutorialSystem, 0, 1, NI_Text_TestFail_OFF, 7)
  MessageBox_Step03 = TriggerPackage:GetStageChanger(TutorialSystem, 0, 1, 0, 7)
  TestSuccessEnd = TriggerPackage:GetTutorialComplete(NI_Text_TestSuccess_OFF)
  TestStage:Register(SpawnHelper01)
  TestStage:Register(CannonadeLoad)
