...
function TypeBind_CostumeSetting()
  AIActor:SetCostume(1000001, 0)
  AIActor:SetCostume(1010015, 0)
  AIActor:SetCostume(1021047, 0)
  AIActor:SetCostume(1031047, 0)
  AIActor:SetCostume(1041047, 0)
  AIActor:SetCostume(1051047, 0)
  AIActor:SetCostume(1061047, 0)
end
function TypeBind_WeaponSetting()
end
function TypeBind_AIActorSetting()
  ...
  TypeBind_AddDeathAIActorState()
  TypeBind_AddNormalAIActorState()
  TypeBind_AddRunAIActorState()
  TypeBind_AddDamageAIActorState()
  TypeBind_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeBind_AddNormalAIActorState()
  ...
  animParam:SetAnim("00074", 0, 1000, 0, true, 1, false)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeBind_AddRunAIActorState()
...
function TypeBind_AddDamageAIActorState()
...
function TypeBind_AddAttackAIActorState()
  local state = StateFactory:GetBindAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitBindAIActorState(250, 250, 250, 3000, 100, 3000)
  state:RegisterSequence(0, "Resources/Effects/skill_bind1.seq", "Resources/Sound/press_shot.ogg", 0, 2500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_RECOVERY = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  index = index + 1
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("S0000", 0, 300, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("S0001", 0, 300, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_RECOVERY, animParam)
  TypeBind_AddAttackAILowerStates(state)
end
function TypeBind_AddAttackAILowerStates(state)
  TypeBind_AddAttackNormalLowerState(state)
  TypeBind_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeBind_AddAttackNormalLowerState(state)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("S0000", 0, 500, 0, true, 1, true)
  lowerState:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeBind_AddAttackRunLowerState(state)
...
function TypeBind_AddDeathAIActorState()
