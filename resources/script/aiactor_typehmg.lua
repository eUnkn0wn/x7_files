...
function TypeHMG_CostumeSetting()
...
function TypeHMG_WeaponSetting()
  AIActor:SetWeapon(2020001, 0)
end
function TypeHMG_AIActorSetting()
  ...
  TypeHMG_AddDeathAIActorState()
  TypeHMG_AddNormalAIActorState()
  TypeHMG_AddRunAIActorState()
  TypeHMG_AddDamageAIActorState()
  TypeHMG_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeHMG_AddNormalAIActorState()
...
function TypeHMG_AddRunAIActorState()
...
function TypeHMG_AddDamageAIActorState()
...
function TypeHMG_AddAttackAIActorState()
  ...
  StateFactory:AddHMGNormalAttacks(state, 11, 150, 0.06)
  local index = 0
  ...
  TypeHMG_AddAttackAILowerStates(state)
end
function TypeHMG_AddAttackAILowerStates(state)
  TypeHMG_AddAttackNormalLowerState(state)
  TypeHMG_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeHMG_AddAttackNormalLowerState(state)
...
function TypeHMG_AddAttackRunLowerState(state)
...
function TypeHMG_AddDeathAIActorState()
