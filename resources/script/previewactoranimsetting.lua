...
function PreviewActorAnimSetting()
  ...
  PreviewActor:SetAnimWithWeaponSubType(WEAPONTYPE_EARTH_BOMB, 2050015, "GB014", 1)
  PreviewActor:SetAnimWithWeaponSubType(WEAPONTYPE_EARTH_BOMB, 2050016, "GB014", 1)
