...
function Common_AddJumpAIActorState()
  ...
  local index = 0
  ANIMPARAMLIST_DELAY_BEFORE_JUMP = index
  index = index + 1
  ANIMPARAMLIST_JUMP_RISE = index
  index = index + 1
  ANIMPARAMLIST_JUMP_MOVE_RISE = index
  index = index + 1
  ANIMPARAMLIST_LANDING = index
  index = index + 1
  ANIMPARAMLIST_LANDING_MOVE = index
  index = index + 1
  ANIMPARAMLIST_FALL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  index = index + 1
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00000", 0, 500, 1000, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_DELAY_BEFORE_JUMP, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00001", 0, 500, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_JUMP_RISE, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00004", 600, 100, 300, false, 1, true)
  ...
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00002", 0, 1000, 0, true, 1, true)
...
function Common_AddFallAIActorState()
  ...
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00003", 380, 200, 300, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_LANDING, animParam)
end
function Common_AddDownAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00021", 0, 1000, 0, true, 1, true)
...
function Common_AddStandUpAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00035", 0, 1000, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function Common_AddBlowAIActorState()
  ...
  index = index + 1
  ANIMPARAMLIST_MIDDLE = index
  index = index + 1
  ANIMPARAMLIST_END = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
  index = index + 1
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00027", 0, 0, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_BEGIN, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00026", 0, 200, 0, true, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_MIDDLE, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00024", 0, 400, 0, false, 1, true)
...
function Common_AddBoundBlowAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00070", 0, 100, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_BEGIN, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00071", 0, 100, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_MIDDLE, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00072", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_END, animParam)
end
function Common_AddDownDamageAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00023", 0, 100, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
...
function Common_AddNormalLowerState(state)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00029", 0, 500, 0, true, 1, true)
...
function Common_AddStunAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00006", 0, 0, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_PRECEDING, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00007", 0, 1000, 0, true, 1, true)
...
function Common_AddDodgeLeftAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00005", 0, 300, 700, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function Common_AddDodgeRightAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("00056", 0, 300, 700, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
