...
function StandardKatana_A_SwordAttack2Dash(OneShotTime, Power, Accuracy, AdditionalPower)
  ...
  local range = WEAPON:GetRange()
  Attack1 = CreateCAttack()
  Attack1:InitAttack1(WEAPONTYPE_KATANA_A_SWORD, ATTACKATTRIB_KATANA_A_ATTACK2_CHARGE, 33, Power * 1.6 + AdditionalPower, AddtionalPower)
  ...
  AddAttack(ATTACKS, Attack1)
  Attack2 = CreateCAttack()
  Attack2:InitAttack1(WEAPONTYPE_KATANA_A_SWORD, ATTACKATTRIB_KATANA_A_ATTACK2_CHARGE, 255, Power * 1.6 + AdditionalPower, AddtionalPower)
  ...
  Attack2:AddBlowCondition(-1500, 3500)
  ...
  Attack8:InitAttack1(WEAPONTYPE_KATANA_A_SWORD, ATTACKATTRIB_KATANA_A_ATTACK2_FULL_CHARGE, 270, Power * 2.75 + AdditionalPower, AddtionalPower)
