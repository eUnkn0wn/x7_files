...
function OnRailGunLicenseTestStep02()
  ...
  ScoreMngBlast01 = TriggerPackage:GetScoreObserver(50, 200, NI_Blast_03, NI_Success, TXT_Weapon_RailGun_23, 15)
  ScoreMngBlast02 = TriggerPackage:GetScoreObserver(2000, 2000, NI_Blast_03, NI_Phase2, TXT_Weapon_RailGun_24, 10)
