...
function TypeCannonade_CostumeSetting()
  AIActor:SetCostume(1001042, 1)
  AIActor:SetCostume(1010004, 0)
  AIActor:SetCostume(1021042, 1)
  AIActor:SetCostume(1031042, 1)
  AIActor:SetCostume(1041042, 1)
  AIActor:SetCostume(1051042, 1)
end
function TypeCannonade_WeaponSetting()
  AIActor:SetWeapon(2030002, 0)
end
function TypeCannonade_AIActorSetting()
  ...
  TypeCannonade_AddDeathAIActorState()
  TypeCannonade_AddNormalAIActorState()
  TypeCannonade_AddRunAIActorState()
  TypeCannonade_AddDamageAIActorState()
  TypeCannonade_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeCannonade_AddNormalAIActorState()
  ...
  animParam:SetAnim("E0018", 0, 1000, 0, true, 1, false)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeCannonade_AddRunAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("E0019", 0, 2000, 0, true, 1, false)
...
function TypeCannonade_AddAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitRailgunAttackAIActorState(1000, 1000, 3000, true)
  state:SetAimingSeq("Resources/Effects/weapon_canon_charge.seq", "Resources/Sound/brail_charge.ogg")
  state:SetMaxAimingSeq("Resources/Effects/weapon_canon_charge_loop.seq", "Resources/Sound/brail_charge_complete.ogg")
  state:SetShotRailSeq("Resources/Effects/weapon_canon_fire.seq", "Resources/Sound/brail_blast", "AreaRailgun_Fire_Dummy")
  state:SetMaxShotRailSeq("Resources/Effects/weapon_canon_fire_max.seq", "Resources/Sound/brail_blast_max.ogg", "AreaRailgun_Fire_Dummy")
  StateFactory:AddCannonadeNormalAttacks(state, 18, 480)
  local animParam
  local animBlender = state:GetAimingAnimBlender()
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("E0001", "E0002", 0, 500, 0, true, 1, true)
  ...
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("E0003", "E0002", 0, 500, 0, true, 1, true)
  ...
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("E0004", "E0005", 1000, 500, 500, false, 1, true)
  animBlender:AddAnimParam(ALSTATE_NORMAL, true, animParam)
  animBlender:AddAnimParam(ALSTATE_RUN, true, animParam)
  animBlender:AddAnimParam(ALSTATE_JUMP, true, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("E0006", "E0005", 1000, 500, 500, false, 1, true)
  animBlender:AddAnimParam(ALSTATE_NORMAL, false, animParam)
  animBlender:AddAnimParam(ALSTATE_RUN, false, animParam)
  animBlender:AddAnimParam(ALSTATE_JUMP, false, animParam)
  TypeCannonade_AddAttackAILowerStates(state)
end
function TypeCannonade_AddAttackAILowerStates(state)
  TypeCannonade_AddAttackNormalLowerState(state)
  TypeCannonade_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeCannonade_AddAttackNormalLowerState(state)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("E0001", 0, 500, 0, true, 1, false)
  lowerState:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeCannonade_AddAttackRunLowerState(state)
