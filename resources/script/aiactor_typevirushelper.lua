...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeVirusHelper_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
  AIActor:SetTeamByID(TEAM_BETA)
  AIActor:SetBaseHP(50)
  AIActor:SetBaseMoveSpeedMax(1500)
...
function TypeVirusHelper_CostumeSetting()
  AIActor:SetCostume(1000001, 0)
  AIActor:SetCostume(1010003, 0)
  AIActor:SetCostume(1021047, 1)
  AIActor:SetCostume(1031047, 1)
  AIActor:SetCostume(1041047, 1)
  AIActor:SetCostume(1051047, 1)
  AIActor:SetCostume(1061047, 1)
end
function TypeVirusHelper_WeaponSetting()
  AIActor:SetWeapon(2060002, 0)
end
function TypeVirusHelper_AIActorSetting()
  ...
  TypeVirusHelper_AddDeathAIActorState()
  TypeVirusHelper_AddNormalAIActorState()
  TypeVirusHelper_AddRunAIActorState()
  TypeVirusHelper_AddDamageAIActorState()
  TypeVirusHelper_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeVirusHelper_AddNormalAIActorState()
  ...
  animParam:SetAnim("00029", 0, 1000, 0, true, 1, false)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeVirusHelper_AddRunAIActorState()
...
function TypeVirusHelper_AddAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  local index = 0
  LIMITEDTAGET_ENEMY = index
  index = index + 1
  LIMITEDTAGET_ALLY = index
  index = index + 1
  LIMITEDTAGET_ALL = index
  index = index + 1
  LIMITEDTAGET_TOTAL = index
  index = index + 1
  ...
  state:SetHealingHP(120, 160)
  local animBlender = state:GetAnimBlender()
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("H0000", "H0001", 0, 500, 0, true, 1, true)
  ...
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("H0002", "H0001", 0, 500, 0, true, 1, true)
  ...
  TypeVirusHelper_AddAttackAILowerStates(state)
end
function TypeVirusHelper_AddAttackAILowerStates(state)
  TypeVirusHelper_AddAttackNormalLowerState(state)
  TypeVirusHelper_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeVirusHelper_AddAttackNormalLowerState(state)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("H0001", 0, 500, 0, true, 1, true)
  lowerState:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeVirusHelper_AddAttackRunLowerState(state)
