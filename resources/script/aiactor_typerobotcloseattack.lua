...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeRobotCloseAttack_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
...
function TypeRobotCloseAttack_CostumeSetting()
...
function TypeRobotCloseAttack_WeaponSetting()
  AIActor:SetWeapon(2000001, 0)
end
function TypeRobotCloseAttack_AIActorSetting()
  ...
  TypeRobotCloseAttack_AddDeathAIActorState()
  TypeRobotCloseAttack_AddNormalAIActorState()
  TypeRobotCloseAttack_AddRunAIActorState()
  TypeRobotCloseAttack_AddDamageAIActorState()
  TypeRobotCloseAttack_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeRobotCloseAttack_AddNormalAIActorState()
...
function TypeRobotCloseAttack_AddRunAIActorState()
...
function TypeRobotCloseAttack_AddDamageAIActorState()
...
function TypeRobotCloseAttack_AddAttackAIActorState()
  ...
  StateFactory:AddPlasmaSwordStrongAttacks(state, 7, 800)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ANIMPARAMLIST_TOTAL = index
...
function TypeRobotCloseAttack_AddDeathAIActorState()
