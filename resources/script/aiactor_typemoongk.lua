...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeMoongK_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
  AIActor:SetBaseMoveSpeedMax(1300)
  AIActor:SetTeamByID(TEAM_BETA)
  AIActor:SetBaseHP(1400)
...
function TypeMoongK_CostumeSetting()
  AIActor:SetCostume(1000019, 0)
  AIActor:SetCostume(1010022, 0)
  AIActor:SetCostume(1020041, 0)
  AIActor:SetCostume(1030039, 0)
  AIActor:SetCostume(1040001, 0)
  AIActor:SetCostume(1050001, 0)
end
function TypeMoongK_WeaponSetting()
  AIActor:SetWeapon(2000004, 0)
end
function TypeMoongK_AIActorSetting()
  ...
  TypeMoongK_AddDeathAIActorState()
  TypeMoongK_AddNormalAIActorState()
  TypeMoongK_AddRunAIActorState()
  TypeMoongK_AddDamageAIActorState()
  TypeMoongK_AddAttack1AIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeMoongK_AddNormalAIActorState()
...
function TypeMoongK_AddRunAIActorState()
...
function TypeMoongK_AddDamageAIActorState()
...
function TypeMoongK_AddAttack1AIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:RegisterSound("Resources/Sound/Acade/Katana_Moogk.ogg", "Bip01", 0, 5000)
  state:InitAttackAIActorState(3000, 0, false, false, 0, true)
  state:RegisterGhostTrail("GhostTrail_katana_sword_01", 500, 1900)
  StateFactory:AddKatanaSword1Acctacks(state, 15, 500)
  local index = 0
  ANIMPARAMLIST_NORMAL = index
  index = index + 1
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("XX004", 0, 200, 0, false, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeMoongK_AddDeathAIActorState()
