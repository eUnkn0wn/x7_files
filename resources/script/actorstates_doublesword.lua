...
function SwordAtkAfterDash1State_DoubleSword(state)
  ...
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("SG000", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("SG026", 0, 1000, 1000, LOOP_FALSE, 1, RESET_TRUE)
end
function SwordAtkAfterDash3State_DoubleSword(state)
  ...
  local ANIMPARAMLIST_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("SG002", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("SG028", 0, 1000, 1000, LOOP_FALSE, 1, RESET_TRUE)
end
function SwordAtkAfterDash4State_DoubleSword(state)
  ...
  local ANIMPARAMLIST_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("SG014", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("SG015", 0, 1000, 1000, LOOP_FALSE, 1, RESET_TRUE)
end
...
function SwordAtkAfterDash5State_DoubleSword(state)
  ...
  local ANIMPARAMLIST_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("SG017", 0, 200, 0, LOOP_TRUE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("SG017", 0, 1000, 1000, LOOP_TRUE, 1, RESET_TRUE)
  ...
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_NORMAL):SetAnim("SG017", 0, 500, 0, LOOP_TRUE, 1, RESET_TRUE)
end
function SwordJumpAtkState_DoubleSword(state)
  ...
  local ANIMPARAMLIST_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_BEGIN):SetAnim("SG012", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_DELAY):SetAnim("SG013", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
end
...
function UseWeapon2State_Double(state)
  ...
  local ANIMPARAMLIST_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_NORMAL):SetAnim("SG016", 0, 200, 0, LOOP_FALSE, 1, RESET_TRUE)
  local lowerPartStateSet = state:GetLowerPartStateSet(0)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_FRONT):SetAnim("SG018", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_FRONT):SetAnim("SG019", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT):SetAnim("SG020", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  ...
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_LEFT_BACK):SetAnim("SG024", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_RIGHT_BACK):SetAnim("SG025", 0, 500, 0, LOOP_TRUE, 1, RESET_FALSE)
  lowerPartStateSet:GetWalkAnimParam(LOWER_ANIM_NORMAL):SetAnim("SG016", 0, 500, 0, LOOP_FALSE, 1, RESET_TRUE)
end
