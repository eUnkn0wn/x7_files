...
function Attack_ROLLING_RenewalDualMagnum(state)
  ...
  index = index + 1
  local ANIMPARAMLIST_LEFT_DELAY = index
  index = index + 1
  local ANIMPARAMLIST_RIGHT = index
  index = index + 1
  local ANIMPARAMLIST_RIGHT_DELAY = index
  index = index + 1
  local ANIMPARAMLIST_BACK = index
  index = index + 1
  local ANIMPARAMLIST_BACK_DELAY = index
  index = index + 1
  state:GetAnimParam(ANIMPARAMLIST_LEFT):SetAnim("DU021", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_LEFT_DELAY):SetAnim("DU022", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_RIGHT):SetAnim("DU023", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_RIGHT_DELAY):SetAnim("DU024", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_BACK):SetAnim("DU019", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
  state:GetAnimParam(ANIMPARAMLIST_BACK_DELAY):SetAnim("DU020", 0, 50, 0, LOOP_FALSE, 1, RESET_TRUE)
end
