...
index = index + 1
function OnMineGunLicenseTest()
  TutorialSystem:SetTotalStage(2)
  OnMineGunLicenseTestStep01()
  OnMineGunLicenseTestStep02()
end
NI_START = 101
...
TXT_Weapon_MineGun_01 = GetString("TXT_Weapon_MineGun_01")
TXT_Weapon_MineGun_02 = GetString("TXT_Weapon_MineGun_02")
TXT_Weapon_MineGun_03 = GetString("TXT_Weapon_MineGun_03")
TXT_Weapon_MineGun_04 = GetString("TXT_Weapon_MineGun_04")
TXT_Weapon_MineGun_05 = GetString("TXT_Weapon_MineGun_05")
TXT_Weapon_MineGun_06 = GetString("TXT_Weapon_MineGun_06")
TXT_Weapon_MineGun_07 = GetString("TXT_Weapon_MineGun_07")
TXT_Weapon_MineGun_08 = GetString("TXT_Weapon_MineGun_08")
TXT_Weapon_MineGun_09 = GetString("TXT_Weapon_MineGun_09")
TXT_Weapon_MineGun_10 = GetString("TXT_Weapon_MineGun_10")
TXT_Weapon_MineGun_11 = GetString("TXT_Weapon_MineGun_11")
TXT_Weapon_MineGun_12 = GetString("TXT_Weapon_MineGun_12")
TXT_Weapon_MineGun_13 = GetString("TXT_Weapon_MineGun_13")
TXT_Weapon_MineGun_14 = GetString("TXT_Weapon_MineGun_14")
TXT_Weapon_MineGun_15 = GetString("TXT_Weapon_MineGun_15")
TXT_Weapon_MineGun_16 = GetString("TXT_Weapon_MineGun_16")
TXT_Weapon_MineGun_17 = GetString("TXT_Weapon_MineGun_17")
TXT_Weapon_MineGun_18 = GetString("TXT_Weapon_MineGun_18")
TXT_Weapon_MineGun_19 = GetString("TXT_Weapon_MineGun_19")
TXT_Weapon_MineGun_20 = GetString("TXT_Weapon_MineGun_20")
TXT_Weapon_MineGun_21 = GetString("TXT_Weapon_MineGun_21")
ClearStringTable()
function OnMineGunLicenseTestStep01()
  MineGunLicense = TutorialSystem:GetEmptyStage()
  ActorSpawn = TriggerPackage:GetSpawnHelper(SPAWN_TRIGGER_BEGIN, SPAWN_FOCUS_ACTOR, "trg_spawn_point_01", 0, 0, 0, 0, true)
  MineGunLoad = TriggerPackage:GetItemDuplicator(0, 2050001, 0, 0)
  SetMineGunData = TriggerPackage:GetSetWeaponData(NI_START, NI_CONGRATULATION, 2050001, 1, -1)
  ...
  Text_Welcom01 = TriggerPackage:GetTextViewerExA(512, 250, NI_START, NI_Text_Welcom01_OFF, TXT_Weapon_MineGun_01, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Welcom02 = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_Welcom01_OFF, NI_Text_Welcom02_OFF, TXT_Weapon_MineGun_02, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Welcom03 = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_Welcom02_OFF, NI_Text_Welcom03_OFF, TXT_Weapon_MineGun_03, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Guide01 = TriggerPackage:GetTextViewerEx(600, 500, NI_Text_Welcom03_OFF, NI_SCORE_COMPLETED01, TXT_Weapon_MineGun_04, "Resources/GUI/New/TutorialImage_1.gui")
  Text_Guide02 = TriggerPackage:GetTextViewerEx(600, 500, NI_Text_CompleteTip01_off, NI_SCORE_COMPLETED02, TXT_Weapon_MineGun_05, "Resources/GUI/New/TutorialImage_1.gui")
  Text_CompleteTip01 = TriggerPackage:GetTextViewerExA(512, 300, NI_SCORE_COMPLETED01, NI_Text_CompleteTip01_off, TXT_Weapon_MineGun_08, "Resources/GUI/New/TutorialImage_0.gui", true, false)
  Text_CompleteTip02 = TriggerPackage:GetTextViewerExA(512, 300, NI_SCORE_COMPLETED02, NI_Text_CompleteTip02_off, TXT_Weapon_MineGun_09, "Resources/GUI/New/TutorialImage_0.gui", true, false)
  Text_ClearStep01 = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_CompleteTip02_off, 0, TXT_Weapon_MineGun_12, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  ScoreCheck01 = TriggerPackage:GetScoreObserver(50, 200, NI_ATTACK_1_SUBMACHINE_GUN, NI_SCORE_COMPLETED01, TXT_Weapon_MineGun_06, 5)
  ScoreCheck02 = TriggerPackage:GetScoreObserver(50, 220, NI_RELOAD_SUBMACHINE_GUN, NI_SCORE_COMPLETED02, TXT_Weapon_MineGun_10, 3)
  Dummy_ScoreCheck01 = TriggerPackage:GetTextViewerEx(50, 200, NI_SCORE_COMPLETED01, 0, TXT_Weapon_MineGun_07, "")
  Dummy_ScoreCheck02 = TriggerPackage:GetTextViewerEx(50, 220, NI_SCORE_COMPLETED02, 0, TXT_Weapon_MineGun_11, "")
  ...
  ActorAttackCheck02 = TriggerPackage:GetActorAttackObserver(NI_SCORE_COMPLETED02, NI_RELOAD_SUBMACHINE_GUN, "RELOAD_MINE_LAUNCHER", ScoreCheck02)
  ...
  MineGunLicense:Register(ActorSpawn)
  MineGunLicense:Register(MineGunLoad)
  MineGunLicense:Register(SetMineGunData)
  MineGunLicense:Register(Timer_TextStart)
  MineGunLicense:Register(Timer_Text_Welcom01_Delay)
  MineGunLicense:Register(Timer_Text_Welcom02_Delay)
  MineGunLicense:Register(Timer_Text_Welcom03_Delay)
  MineGunLicense:Register(Timer_Text_CompleteTip01_on)
  MineGunLicense:Register(Timer_Text_CompleteTip01_off)
  MineGunLicense:Register(Timer_Text_CompleteTip02_on)
  MineGunLicense:Register(Timer_Text_CompleteTip02_off)
  MineGunLicense:Register(Text_ClearStep01)
  MineGunLicense:Register(KeyPermiter01)
  MineGunLicense:Register(KeyPermiter02)
  MineGunLicense:Register(KeyPermiter03)
  MineGunLicense:Register(KeyPermiter04)
  MineGunLicense:Register(KeyPermiter05)
  MineGunLicense:Register(KeyPermiter06)
  MineGunLicense:Register(Text_Welcom01)
  MineGunLicense:Register(Text_Welcom02)
  MineGunLicense:Register(Text_Welcom03)
  MineGunLicense:Register(Text_Guide01)
  MineGunLicense:Register(Text_Guide02)
  MineGunLicense:Register(Text_CompleteTip01)
  MineGunLicense:Register(Text_CompleteTip02)
  MineGunLicense:Register(Dummy_ScoreCheck01)
  MineGunLicense:Register(Dummy_ScoreCheck02)
  MineGunLicense:Register(RegActorAttackCheck01)
  MineGunLicense:Register(RegActorAttackCheck02)
  MineGunLicense:Register(NarOK01)
  MineGunLicense:Register(NarOK02)
  MineGunLicense:Register(RegGateOpen_Step01)
  MineGunLicense:Register(Arrow_Gate_off_01)
  MineGunLicense:Register(Arrow_Gate_on_01)
  MineGunLicense:Register(MessageBox_Step01)
  MineGunLicense:Register(Congraturation_Step01)
  MineGunLicense:Register(BlastObject01)
  MineGunLicense:Register(BlastObject02)
  MineGunLicense:Register(InviBox)
  MineGunLicense:Register(BlastObject02AnimController)
  MineGunLicense:Register(InviBox02)
  MineGunLicense:Register(BlastObject03AnimController)
  MineGunLicense:Register(InviBox03)
  MineGunLicense:Register(BlastObject04AnimController)
  MineGunLicense:Register(InviBox04)
  MineGunLicense:Register(BlastObject05AnimController)
  TutorialSystem:AddStage(0, MineGunLicense)
end
NI_Start_Step02 = 201
...
NI_Rebirth02 = 215
NI_Des02 = 216
function OnMineGunLicenseTestStep02()
  ...
  MineGunLoad = TriggerPackage:GetItemDuplicator(0, 2050001, 0, 0)
  SetMineGunData = TriggerPackage:GetSetWeaponData(NI_Start_Step02, NI_Success, 2050001, 1, -1)
  ...
  TriggerPackage:SetShowEventAlram(Timer_End, 470, 50, TXT_Weapon_MineGun_13, 1)
  ...
  Text_Step02Start = TriggerPackage:GetTextViewerExA(512, 250, NI_Start_Step02, NI_Text_Step02Start_off, TXT_Weapon_MineGun_14, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Step02Ready = TriggerPackage:GetTextViewerExA(512, 250, NI_Text_Step02Start_off, NI_TestStart_Step02, TXT_Weapon_MineGun_15, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_TestStartStep02 = TriggerPackage:GetTextViewerExA(512, 250, NI_TestStart_Step02, NI_Text_TestStartStep02_OFF, TXT_Weapon_MineGun_16, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_Guide_Step02_01 = TriggerPackage:GetTextViewerEx(600, 500, NI_TestStart_Step02, NI_Text_TestSuccess_OFF, TXT_Weapon_MineGun_17, "Resources/GUI/New/TutorialImage_1.gui")
  Text_TestFail = TriggerPackage:GetTextViewerExA(512, 250, NI_Fail, NI_Text_TestFail_OFF, TXT_Weapon_MineGun_18, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  Text_TestSuccess = TriggerPackage:GetTextViewerExA(512, 200, NI_Success, NI_Text_TestSuccess_OFF, TXT_Weapon_MineGun_19, "Resources/GUI/New/TutorialImage_1.gui", true, false)
  ScoreCheck01 = TriggerPackage:GetScoreObserver(50, 200, NI_Des, NI_Success, TXT_Weapon_MineGun_20, 3)
  Dummy_ScoreCheck01 = TriggerPackage:GetTextViewerEx(50, 200, NI_SCORE_COMPLETED03, 0, TXT_Weapon_MineGun_21, "")
  ...
  InPutLicense = TriggerPackage:GetItemLicensed(NI_Success, 10)
  ...
  TestStage:Register(MineGunLoad)
  TestStage:Register(SetMineGunData)
