...
function TypeVirusEsperS_CostumeSetting()
  AIActor:SetCostume(1001043, 0)
  AIActor:SetCostume(1010017, 0)
  AIActor:SetCostume(1021043, 1)
  AIActor:SetCostume(1031043, 1)
  AIActor:SetCostume(1041043, 1)
  AIActor:SetCostume(1051043, 1)
  AIActor:SetCostume(1061043, 1)
end
function TypeVirusEsperS_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeVirusEsperS_AIActorSetting()
  ...
  TypeVirusEsperS_AddDeathAIActorState()
  TypeVirusEsperS_AddNormalAIActorState()
  TypeVirusEsperS_AddRunAIActorState()
  TypeVirusEsperS_AddDamageAIActorState()
  TypeVirusEsperS_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeVirusEsperS_AddNormalAIActorState()
...
function TypeVirusEsperS_AddRunAIActorState()
...
function TypeVirusEsperS_AddDamageAIActorState()
...
function TypeVirusEsperS_AddAttackAIActorState()
  ...
  TypeVirusEsperS_AddAttackAILowerStates(state)
end
function TypeVirusEsperS_AddAttackAILowerStates(state)
  TypeVirusEsperS_AddAttackNormalLowerState(state)
  TypeVirusEsperS_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeVirusEsperS_AddAttackNormalLowerState(state)
...
function TypeVirusEsperS_AddAttackRunLowerState(state)
...
function TypeVirusEsperS_AddDeathAIActorState()
