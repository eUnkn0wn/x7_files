...
wCostumeBottom[3] = 10
wCostumeBottom[4] = 27
function TypeVirusEsperSS2_Init()
  TEAM_ALPHA = 1
  TEAM_BETA = 2
...
function TypeVirusEsperSS2_CostumeSetting()
  AIActor:SetCostume(1001043, 1)
  AIActor:SetCostume(1010017, 0)
  AIActor:SetCostume(1021044, 1)
  AIActor:SetCostume(1031044, 1)
  AIActor:SetCostume(1041044, 1)
  AIActor:SetCostume(1051044, 1)
  AIActor:SetCostume(1061044, 1)
end
function TypeVirusEsperSS2_WeaponSetting()
  AIActor:SetWeapon(2010001, 0)
end
function TypeVirusEsperSS2_AIActorSetting()
  ...
  TypeVirusEsperSS2_AddDeathAIActorState()
  TypeVirusEsperSS2_AddNormalAIActorState()
  TypeVirusEsperSS2_AddRunAIActorState()
  TypeVirusEsperSS2_AddDamageAIActorState()
  TypeVirusEsperSS2_AddAttackAIActorState()
  AIActor:ChangeAIActorState(AASTATE_NORMAL)
end
function TypeVirusEsperSS2_AddNormalAIActorState()
  ...
  animParam:SetAnim("00074", 0, 1000, 0, true, 1, true)
  state:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeVirusEsperSS2_AddRunAIActorState()
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("D0027", 0, 1000, 0, true, 1, false)
  state:RegisterAnimParam(ANIMPARAMLIST_UPPER_FRONT, animParam)
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("D0028", 0, 1000, 0, true, 1, false)
...
function TypeVirusEsperSS2_AddDamageAIActorState()
...
function TypeVirusEsperSS2_AddAttackAIActorState()
  ...
  state:SetNextStateID(AAINPUT_DODGE_LEFT, AASTATE_DODGE_LEFT)
  state:SetNextStateID(AAINPUT_DODGE_RIGHT, AASTATE_DODGE_RIGHT)
  state:InitAttackAIActorState(600, 0, true, true, 0, false)
  StateFactory:AddSMGNormalAttacks(state, 3, 125, 0.04)
  local animBlender = state:GetAnimBlender()
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("D0000", "D0001", 0, 500, 0, true, 2, true)
  ...
  animParam = StateFactory:GetAnimParam()
  animParam:SetBlendingAnim("D0002", "D0001", 0, 500, 0, true, 2, true)
  ...
  TypeVirusEsperSS2_AddAttackAILowerStates(state)
end
function TypeVirusEsperSS2_AddAttackAILowerStates(state)
  TypeVirusEsperSS2_AddAttackNormalLowerState(state)
  TypeVirusEsperSS2_AddAttackRunLowerState(state)
  Common_AddJumpLowerState(state)
end
function TypeVirusEsperSS2_AddAttackNormalLowerState(state)
  ...
  local animParam
  animParam = StateFactory:GetAnimParam()
  animParam:SetAnim("D0002", 0, 500, 0, true, 1, true)
  lowerState:RegisterAnimParam(ANIMPARAMLIST_NORMAL, animParam)
end
function TypeVirusEsperSS2_AddAttackRunLowerState(state)
